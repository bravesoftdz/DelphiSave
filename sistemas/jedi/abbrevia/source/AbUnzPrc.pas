...
var
  Confirm    : Boolean;
  {$IFDEF AbUnZipClobber} //THu we need OutStream only for AbUnzipClobber or AbUnzipMemory
  OutStream  : TFileStream;
  {$ENDIF}
  {$IFDEF AbUnZipMemory}
  TempOut    : TMemoryStream;
  OutStream  : TFileStream; //THu REM: both defines can't be set at the same time (see AbDefine.inc!)
  {$ENDIF}
