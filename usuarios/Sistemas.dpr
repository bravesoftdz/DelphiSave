...
uses
  ...
  unGestionSistemas in 'unGestionSistemas.pas' {frmGestionSistemas: TFSForm},
  unManSectoresIntranet in 'unManSectoresIntranet.pas' {frmManSectoresIntranet: TFSForm},
  ...
  unManCMS_MOTIVOSOLICITUD in 'unManCMS_MOTIVOSOLICITUD.pas' {frmManCMS_MOTIVOSOLICITUD: TFSForm},
  unArbolSectores in 'unArbolSectores.pas' {frmArbolSectores},
  ...
  unManConsultasRotulos in '..\sistemas\unManConsultasRotulos.pas' {frmManConsultasRotulo: TFSForm},
  unManReportesWeb in '..\sistemas\unManReportesWeb.pas' {frmManReportesWeb: TFSForm},
  unManRotulosReporte in '..\sistemas\unManRotulosReporte.pas' {frmManRotulosReporte: TFSForm},
  unManAlertas in '..\alertas\abm\unManAlertas.pas' {frmManAlertas: TFSForm},
  unCustomAccionABM in '..\alertas\abm\unCustomAccionABM.pas' {frmCustomAccionABM: TFSForm},
  unManAcciones in '..\alertas\abm\unManAcciones.pas' {frmManAcciones: TFSForm},
  unfraUsuariosExternos in '..\comunes\frames\unfraUsuariosExternos.pas' {fraUsuariosExternos: TFrame},
  unfrmTesteoProgramacion in '..\alertas\unfrmTesteoProgramacion.pas' {frmTesteoProgramacion},
  unMonitorAlertas in '..\alertas\unMonitorAlertas.pas' {frmMonitorAlertas: TFSForm},
  unDmMonitor in '..\alertas\comunes\unDmMonitor.pas' {dmMonitor: TDataModule},
  unManEquipos in 'unManEquipos.pas' {frmManEquipos: TFSForm},
  unElementosEnviadosGlobal in '..\sistemas\unElementosEnviadosGlobal.pas' {frmElementosEnviadosGlobal: TFSForm},
  UnAlertas in '..\comunes\UnAlertas.pas',
  ...
  unManProcesosOracle in '..\impoexpo\abm\unManProcesosOracle.pas' {frmManProcesosOracle: TFSForm},
  unManArchivosExp in '..\impoexpo\abm\unManArchivosExp.pas' {frmManArchivosExp: TFSForm},
  unEventosABM in '..\impoexpo\unEventosABM.pas' {frmEventosABM},
  unMigraciones in '..\impoexpo\unMigraciones.pas' {frmMigraciones},
  unManConsultas in '..\impoexpo\abm\unManConsultas.pas' {frmManConsultas: TFSForm},
  ...
  unExpoImpoUtils in '..\comunes\unExpoImpoUtils.pas',
  ...
  unJediFunctions in '..\sistemas\unJediFunctions.pas',
  unVerArchivoControlVersion in '..\sistemas\unVerArchivoControlVersion.pas' {frmVerArchivoControlVersion},
  unBusquedaControlVersion in '..\sistemas\unBusquedaControlVersion.pas' {frmBusquedaControlVersion: TFSForm},
  ...
  unManWAW_ACCIONWEB in '..\comunes\forms\unManWAW_ACCIONWEB.pas' {frmManWAW_ACCIONWEB: TFSForm},
  unManWAP_ACCIONPARAMETROS in '..\comunes\forms\unManWAP_ACCIONPARAMETROS.pas' {frmManWAP_ACCIONPARAMETROS: TFSForm},
  ...
  ActiveDs_TLB in 'ActiveDirectory\WinNT\ActiveDs_TLB.pas',
  adshlp in 'ActiveDirectory\WinNT\adshlp.pas',
  unActiveDirectory_Usuarios in 'ActiveDirectory\WinNT\unActiveDirectory_Usuarios.pas' {frmUser},
  unActiveDirectory_Dominio in 'ActiveDirectory\WinNT\unActiveDirectory_Dominio.pas' {frmChooseDomain},
  unActiveDirectory_Grupos in 'ActiveDirectory\WinNT\unActiveDirectory_Grupos.pas' {frmGroup},
  unActiveDirectory_ListaDeGrupos in 'ActiveDirectory\WinNT\unActiveDirectory_ListaDeGrupos.pas' {frmGroupList},
  unfraCuentaBancaria in '..\comunes\frames\new\unfraCuentaBancaria.pas' {fraCuentaBancaria: TFrame},
  unCargaLT in '..\uif\terrorismo\lt\unCargaLT.pas',
  unComunesLT in '..\uif\terrorismo\lt\unComunesLT.pas',
  unLogsLT in '..\uif\terrorismo\lt\unLogsLT.pas',
  unRelevLT in '..\uif\terrorismo\lt\unRelevLT.pas',
  unStringsLT in '..\uif\terrorismo\lt\unStringsLT.pas',
  unTesterLT in '..\uif\terrorismo\lt\unTesterLT.pas' {TesterUIF},
  ...
  unImageSplash in 'unImageSplash.pas' {frmImageSplash},
  unFraUsuarioConSectorIntranet in '..\comunes\frames\new\unFraUsuarioConSectorIntranet.pas' {fraUsuarioConSectorIntranet: TFrame},
  unEstadisticas in 'unEstadisticas.pas' {frmEstadisticas: TFSForm},
  unfraDelegacion in '..\comunes\frames\unfraDelegacion.pas' {fraDelegacion: TFrame},
  unRptSolicitudCambioExe in 'reports\unRptSolicitudCambioExe.pas' {qrSolicitudCambioExe: TQuickRep},
  unSolicitudesCambioExe in 'unSolicitudesCambioExe.pas' {frmSolicitudesCambioExe: TFSForm},
  Frm_Esrtructura in '..\documentador\Frm_Esrtructura.pas' {Frm_Estructura},
  Frm_Consulta in '..\documentador\Frm_Consulta.pas' {Frm_Consultas},
  Frm_DocumTabla in '..\documentador\Frm_DocumTabla.pas' {Frm_DocTabla},
  Frm_Login in '..\documentador\Frm_Login.pas' {Login},
  BaseDeDatos in '..\documentador\BaseDeDatos.pas' {DM_BaseDeDatos: TDataModule},
  Frm_Filtros in '..\documentador\Frm_Filtros.pas' {Frm_Filtrar},
  QRpt_RepOwner in '..\documentador\Reportes\QRpt_RepOwner.pas' {QRpt_Owner_Tablas: TQuickRep},
  Frm_Reporte in '..\documentador\Frm_Reporte.pas' {Frm_Reportes},
  Frm_VisCodigos in '..\documentador\Frm_VisCodigos.pas' {Frm_VisCodigo},
  QRpt_RepCodigo in '..\documentador\Reportes\QRpt_RepCodigo.pas' {QRpt_RepCodigos: TQuickRep},
  QRpt_RepDescripciones in '..\documentador\Reportes\QRpt_RepDescripciones.pas' {Qrpt_Descripciones: TQuickRep},
  Frm_TabDocu in '..\documentador\Frm_TabDocu.pas' {Frm_TablaDocEspecial},
  Frm_DocObjetos in '..\documentador\Frm_DocObjetos.pas' {Frm_DocObjects},
  UnTDbNodo in '..\documentador\UnTDbNodo.pas',
  UnTamSegments in '..\documentador\UnTamSegments.pas' {Frm_TamSegment},
  unCompileSchemas in '..\documentador\unCompileSchemas.pas' {frmCompInvalid},
  unDataEdit in '..\documentador\unDataEdit.pas' {frmDataEdit},
  unAltaSolicitudesCambioExe in 'unAltaSolicitudesCambioExe.pas' {frmAltaSolicitudesCambioExe},
  ...
  unRptTicket in 'Reports\unRptTicket.pas' {qrTicket: TQuickRep},
  ...
  unManUsuariosMantenimiento in 'unManUsuariosMantenimiento.pas' {frmManUsuariosMantenimiento: TFSForm},
  ...
  unPedidosEnviados in 'unPedidosEnviados.pas' {frmPedidosEnviados: TFSForm},
  Modbus in 'temperaturahumedad\Modbus.pas',
  unTesoreria in '..\afiliaciones\tesoreria\unTesoreria.pas',
  unDestinatarioTickets in '..\sistemas\unDestinatarioTickets.pas' {frmDestinatarioTickets: TFSForm},
  ...
  unAlertaTypes in '..\comunes\unAlertaTypes.pas',
  ...
  unEstadoServicios in '..\sistemas\unEstadoServicios.pas' {frmEstadoServicios},
  ...
  unManTercUsuarios in 'unManTercUsuarios.pas' {frmManTercUsuarios: TFSForm},
  unManTercEmpresas in 'unManTercEmpresas.pas' {frmManTercEmpresas: TFSForm},
  ...
  unBloqueosDB in '..\sistemas\unBloqueosDB.pas' {frmBloqueosDB},
  unSistemasdeTickets in 'unSistemasdeTickets.pas' {frmSistemasDeTickets: TFSForm},
  unSMS_BandejaEntrada in '..\comunes\forms\unSMS_BandejaEntrada.pas' {frmSMS_BandejaEntrada: TFSForm},
  unFraCustomABM in '..\comunes\frames\nuevos\unFraCustomABM.pas' {fraCustomABM: TFrame},
  unFraCustomGridABM in '..\comunes\frames\nuevos\unFraCustomGridABM.pas' {fraCustomGridABM: TFrame},
  unCustomABM in '..\comunes\reposit\unCustomABM.pas' {frmCustomABM},
  unManCTJ_TRABAJADOR in '..\comunes\forms\unManCTJ_TRABAJADOR.pas' {frmManCTJ_TRABAJADOR},
  unFraTipoRegimen in '..\comunes\frames\new\unFraTipoRegimen.pas' {fraTipoRegimen: TFrame},
  unManProcesos in '..\impoexpo\abm\unManProcesos.pas' {frmManProcesos: TFSForm},
  unImpoExpoUtils in '..\impoexpo\unImpoExpoUtils.pas',
  unSeleccionSistemaTickets in '..\sistemas\unSeleccionSistemaTickets.pas' {frmSeleccionSistemaTickets};
...
begin
  ...
  Application.Title := 'Administración de Sistemas';
  ...
  try
    ...
    begin
      ...
      Application.CreateForm(TDM_BaseDeDatos, DM_BaseDeDatos);
    end;
  finally
    Free;
  end;
