object RptLiqSumariosAprobadas: TRptLiqSumariosAprobadas
  Left = 0
  Top = 0
  Width = 1056
  Height = 816
  ...
  object qrbPieBeneficiario: TQRBand
    ...
    object QRLabel10: TQRLabel
      ...
      AutoSize = False
      AutoStretch = False
      Caption = 'Liquidaciones del Sumario:'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object QRBand1: TQRBand
    ...
    object QRExpr5: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(IF(ordennro = 0,1,0))'
      FontSize = 8
    end
    ...
    object QRExpr6: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(IF(ordennro = 0,ps_importeconretencion,0))'
      FontSize = 8
    end
    object QRExpr7: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(IF(ordennro = 0,ps_importepago,0))'
      FontSize = 8
    end
  end
