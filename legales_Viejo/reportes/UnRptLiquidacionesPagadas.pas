{-----------------------------------------------------------------------------
 Unit Name: UnRptLiquidacionesPagadas
 Author:    RACastro
 Date:      15-Jun-2006
 Purpose:   Listado de liquidaciones pagadas dentro de un período
 History:
-----------------------------------------------------------------------------}
unit UnRptLiquidacionesPagadas;
...
type
  TRptLiquidacionesPagadas = class(TQuickRep)
...
-----------------------------------------------------------------------------}
procedure TRptLiquidacionesPagadas.VistaPrevia(ASql: TSDQuery;
...
{-----------------------------------------------------------------------------
  ...
  Purpose:   Define dinámicamente el alto del detalle en base al pago de la
             liquidación
-----------------------------------------------------------------------------}
procedure TRptLiquidacionesPagadas.sdqLiquidacionAfterScroll(
  DataSet: TDataSet);
begin
...
-----------------------------------------------------------------------------}
procedure TRptLiquidacionesPagadas.CargarDatosPagoFinancials;
var
  bFnlActive: Boolean;
