unit UnRptLiqSumariosAprobadas;
...
type
  TRptLiqSumariosAprobadas = class(TQuickRep)
...
{$R *.DFM}
procedure TRptLiqSumariosAprobadas.VistaPrevia(ASql: TSDQuery;
...
procedure TRptLiqSumariosAprobadas.sdqLiquidacionAfterScroll(
  DataSet: TDataSet);
begin
...
procedure TRptLiqSumariosAprobadas.CargarDatosPagoFinancials;
var
  bFnlActive: Boolean;
