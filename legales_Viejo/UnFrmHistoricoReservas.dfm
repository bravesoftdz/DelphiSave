object frmHistoricoReservas: TfrmHistoricoReservas
  Left = 201
  Top = 109
  Width = 761
  Height = 322
  ...
  object dbGridAbogadosJuicio: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'HR_RESERVACAPITALCALCULADA'
      ...
      item
        Expanded = False
        FieldName = 'HR_RESERVAHONORARIOCALCULADA'
      ...
      item
        Expanded = False
        FieldName = 'HR_RESERVAHONORARIOS'
      ...
      item
        Expanded = False
        FieldName = 'HR_USUARIOAPROBORESERVA'
        Title.Caption = 'Aprob'#243
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'HR_FECHAAPROBACIONRESERVA'
        Title.Caption = 'Fecha Aprobaci'#243'n'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'HR_RESERVAEFECTUADA'
        Title.Caption = 'Reserva Efectuada'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'HR_OBSERVACIONES'
  ...
  object sdqHistoricoReservas: TSDQuery
    ...
    SQL.Strings = (
      'select  * from legales.lhr_historicoreserva'
      'where hr_idjuicioentramite = :IDJUICIOENTRAMITE'
      'order by hr_id desc'
      ''
      '')
    Left = 35
