object frmRptEventosRecupero: TfrmRptEventosRecupero
  Left = -4
  Top = -4
  Width = 808
  Height = 608
  Caption = 'frmRPTEventosRecupero'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object rptEventosRecupero: TQuickRep
    Left = 23
    Top = 2
    Width = 816
    Height = 1056
    ...
    object qrbTitulo: TQRBand
      ...
      object qrdTrabajador: TQRDBText
        Left = 212
        Top = 69
        Width = 87
        Height = 17
      ...
      object qrdFechaAccidente: TQRDBText
        Left = 118
        Top = 87
        Width = 141
        Height = 17
      ...
      object qrdPrestMedicos: TQRDBText
        Left = 118
        Top = 242
        Width = 75
        Height = 17
      ...
      object QRLabel19: TQRLabel
        ...
        AutoSize = False
        AutoStretch = True
        Caption = 'LISTADO DE EVENTOS - ADMINISTRACI'#211'N DE RECUPEROS'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
  ...
  object sdqReporteDET: TSDQuery
    ...
    SQL.Strings = (
        ...
        'Select Re_NroEvento, Re_Codigo, Tb_Descripcion, Re_Fecha, Re_Obs' +
        'ervaciones'
      '  From Ctb_Tablas, Lre_RecuperoEventos'
      ' Where Tb_Codigo   = Re_Codigo'
      '   and Tb_Clave'#9'   = '#39'EVRES'#39
      '   and Re_NroEvento > 0  '
      '   and Re_Siniestro = :nNroSiniestro'
      '   and Re_Orden     = :nNroOrden')
    Top = 28
    ParamData = <
      item
        DataType = ftUnknown
  ...
  object sdqReporteCAB: TSDQuery
    ...
    SQL.Strings = (
        ...
        'nombre empresa, ex_cuil cuil,'
      
        'tj_nombre trabajador, ex_fechaaccidente, DECODE(EX_TIPO, '#39'1'#39', '#39'L' +
        'UGAR DE TRABAJO'#39', '#39'2'#39', '#39'IN ITINERE'#39', '#39'3'#39', '#39'ENFERMEDAD PROFESIONA' +
        'L'#39', '#39'LUGAR DE TRABAJO'#39') TipoAccidente, ex_accidentetransito,'
      
        'DECODE( ex_causafin, '#39'02'#39', '#39'Rechazo'#39', '#39'03'#39', '#39'Solo Prestaciones E' +
        'n Especie'#39', '#39'05'#39', '#39'Prestaciones Otorgadas'#39', '#39'10'#39' ,'#39'Mortal Sin De' +
        'rechohabientes'#39' , '#39'95'#39', '#39'Informaci'#243'n Suministrada Erroneamente'#39',' +
        ' '#39'99'#39', '#39'Error de Carga'#39', NULL) causafin,'
      'art.liq.Get_ImporteLiquidadoILT(ex_siniestro,ex_orden,null) ilt,'
        ...
        'art.liq.Get_ImporteLiquidadoMortales(ex_siniestro,ex_orden,ex_re' +
        'caida) mortales,'
