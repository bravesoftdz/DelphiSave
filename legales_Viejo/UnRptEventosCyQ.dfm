object frmRptEventosCyQ: TfrmRptEventosCyQ
  Left = -4
  Top = -4
  Width = 808
  Height = 608
  Caption = 'frmRPTEventosCyQ'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object rptEventosCyQ: TQuickRep
    Left = 23
    Top = 2
    Width = 816
    Height = 1056
    ...
    object qrbTitulo: TQRBand
      ...
      object QRLabel19: TQRLabel
        ...
        AutoSize = False
        AutoStretch = True
        Caption = 'LISTADO DE EVENTOS - ADMINISTRACI'#211'N DE CONCURSOS Y QUIEBRAS'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
  ...
  object sdqReporteCAB: TSDQuery
    ...
    Options = []
    SQL.Strings = (
      'SELECT CQ_NROORDEN, BO_NOMBRE, CQ_CUIT, EM_NOMBRE,'
      
        '       CQ_FUERO, FUERO.TB_DESCRIPCION FUERO, CQ_JUZGADO, CQ_SECR' +
        'ETARIA,'
      '       CQ_JURISDICCION, JURIS.JU_DESCRIPCION JURISDICCION'
      '  FROM AEM_EMPRESA, LCQ_CONCYQUIEBRA, LEGALES.LBO_ABOGADO,'
      '       CTB_TABLAS FUERO, LEGALES.LJU_JURISDICCION JURIS'
      ' WHERE EM_CUIT = CQ_CUIT'
      '   AND BO_ID(+) = CQ_ABOGADO'
      '   AND FUERO.TB_CLAVE(+) = '#39'FUERO'#39
      '   AND FUERO.TB_CODIGO(+) = CQ_FUERO'
      '   AND JURIS.JU_ID(+) = CQ_JURISDICCION'
      '   AND CQ_NROORDEN = :nNroOrden'
      '')
    Left = 1
    Top = 1
    ParamData = <
