...
var
   sSqlTrans : TSql;
begin
  VerificarMultiple(['Validación de Origen de Demanda',
        fraReclamante,
    ...
    case nbOrigenDemanda.PageIndex of
        OD_TRABAJADOR      : begin
                              VerificarMultiple(['Validación de Origen de Demanda',
                                                  ...
                                                  'Si la demanda es dentro del régimen debe especificar siniestros.',
                                                  chkOrigenDemanda,
                                                  ...
                                                  'Si la demanda no es dentro del régimen no debe especificar siniestros.',
                                                  edSalarioDeclarado,
      ...
      OD_EMPRESAAFILIADA : begin
                              VerificarMultiple(['Validación de Origen de Demanda - Empresa Afiliada',
      ...
      OD_EMPRESA         : begin
                             VerificarMultiple(['Validación de Origen de Demanda - Empresa No Afiliada',
                                                  edCuitEmpresa,
                                                  edCuitEmpresa.Text <> '',
                                                  ...
                                                  'Debe completar la razón social de la empresa.'
                                                  ]);
      ...
      OD_PERSONA         : begin
                             VerificarMultiple([
                                    'Validación de Origen de Demanda - Persona',
      ...
      OD_PRESTADOR       : begin
                             VerificarMultiple([
                                    'Validación de Origen de Demanda - Prestador',
                                    fraEmpresaPrestador,
