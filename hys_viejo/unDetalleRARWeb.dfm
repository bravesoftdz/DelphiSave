inherited frmDetalleRARWeb: TfrmDetalleRARWeb
  Caption = 'Detalle RAR Web'
  ClientHeight = 560
  ClientWidth = 782
  ...
  object Grid: TArtDBGrid [0]
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'dw_fechainiexpo'
        Title.Caption = 'Fecha Inicio de la exposici'#243'n'
        Width = 143
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'dw_sectortrab'
        Title.Caption = 'Sector de trabajo'
        Width = 91
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'dw_puestotrab'
  ...
  object AdvToolPanelTab: TAdvToolPanelTab [2]
    Left = 532
    Top = 192
    Width = 250
    Height = 339
  ...
  object tsDatos: TPageControl [3]
    ...
    object TabSheet2: TTabSheet
      ...
      object Label6: TLabel
        ...
        Width = 89
        Height = 13
        Caption = 'Descripci'#243'n Estab.'
      end
      object edTipoNomina: TEdit
        Left = 110
        Top = 27
        Width = 278
        Height = 21
      ...
      object edDescripcionEstab: TMemo
        Left = 110
        Top = 77
        Width = 648
        Height = 43
    ...
    object TabSheet3: TTabSheet
      ...
      ImageIndex = 2
      object tsResponsables: TPageControl
        Left = 0
        Top = 0
        Width = 774
        Height = 164
        ...
        object HYS: TTabSheet
          ...
          object edApellidoRespHYS: TEdit
            Left = 265
            Top = 8
            Width = 157
            Height = 21
          ...
          inline fraCargoRespHYS: TfraCtbTablas
            Left = 471
            Top = 8
            Width = 295
            Height = 23
          ...
          object edTelefonoRespHYS: TEdit
            Left = 174
            Top = 34
            Width = 115
            Height = 21
          ...
          object cbPrincipalRespHYS: TCheckBox
            Left = 693
            Top = 36
            Width = 67
            Height = 17
          ...
          inline fraTipoTelefonoRespHYS: TfraCodDesc
            Left = 433
            Top = 32
            Width = 260
            Height = 23
          ...
          object edTipoDocumentoRespHYS: TEdit
            Left = 54
            Top = 59
            Width = 55
            Height = 21
          ...
          object edDocumentoRespHYS: TEdit
            Left = 174
            Top = 59
            Width = 115
            Height = 21
          ...
          object edObservacionRespHYS: TMemo
            Left = 73
            Top = 85
            Width = 689
            Height = 43
        ...
        object Empresa: TTabSheet
          ...
          object edApellidoRespEmpresa: TEdit
            Left = 265
            Top = 8
            Width = 157
            Height = 21
          ...
          object edNombreRespEmpresa: TEdit
            Left = 54
            Top = 8
            Width = 159
            Height = 21
          ...
          inline fraCargoRespEmpresa: TfraCtbTablas
            Left = 471
            Top = 8
            Width = 295
            Height = 23
          ...
          object edEmailRespEmpresa: TEdit
            Left = 432
            Top = 59
            Width = 330
            Height = 21
          ...
          object edCodAreaRespEmpresa: TEdit
            Left = 54
            Top = 34
            Width = 55
            Height = 21
          ...
          object edTelefonoRespEmpresa: TEdit
            Left = 174
            Top = 34
            Width = 115
            Height = 21
          ...
          object edInternoRespEmpresa: TEdit
            Left = 334
            Top = 34
            Width = 55
            Height = 21
          ...
          object cbPrincipalRespEmpresa: TCheckBox
            Left = 693
            Top = 36
            Width = 67
            Height = 17
          ...
          inline fraTipoTelRespEmpresa: TfraCodDesc
            Left = 433
            Top = 32
            Width = 260
            Height = 23
          ...
          object edTipoDocRespEmpresa: TEdit
            Left = 54
            Top = 59
            Width = 55
            Height = 21
          ...
          object edDocumentoRespEmpresa: TEdit
            Left = 174
            Top = 59
            Width = 115
            Height = 21
          ...
          object edSexoRespEmpresa: TEdit
            Left = 334
            Top = 59
            Width = 55
            Height = 21
          ...
          object edObservacionRespEmpresa: TMemo
            Left = 73
            Top = 85
            Width = 689
            Height = 43
        ...
        object Contacto: TTabSheet
          ...
          object edApellidoContacto: TEdit
            Left = 265
            Top = 8
            Width = 157
            Height = 21
          ...
          object edCodAreaContacto: TEdit
            Left = 54
            Top = 34
            Width = 55
            Height = 21
          ...
          object edInternoContacto: TEdit
            Left = 334
            Top = 34
            Width = 55
            Height = 21
          ...
          object cbPrincipalContacto: TCheckBox
            Left = 693
            Top = 36
            Width = 67
            Height = 17
          ...
          inline fraTipoTelContacto: TfraCodDesc
            Left = 433
            Top = 32
            Width = 260
            Height = 23
          ...
          object edTipoDocContacto: TEdit
            Left = 54
            Top = 59
            Width = 55
            Height = 21
          ...
          object edDocumentoContacto: TEdit
            Left = 174
            Top = 59
            Width = 115
            Height = 21
          ...
          object edObservacionContacto: TMemo
            Left = 73
            Top = 85
            Width = 689
            Height = 43
  ...
  inherited ilByN: TImageList
    ...
    Top = 580
    Bitmap = {
      494C01011F002100540010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited IconosXP: TImageList
    ...
    Top = 580
    Bitmap = {
      494C010130003200540010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object sdqConsulta: TSDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT dw_cuil, dw_nombre, dw_fechaingreso, dw_fechainiexpo, dw_' +
        'sectortrab,'
      '       dw_puestotrab,'
      '       (SELECT listagg (rg_esop || '#39' '#39' || rg_sufijoesop, '#39','#39')'
      '               WITHIN GROUP (ORDER BY rg_esop, rg_sufijoesop)'
      '        FROM   art.prg_riesgos, hys.hrt_riestrabweb'
      '         WHERE rt_idriesgo = rg_id'
      '           AND rg_fechabaja IS NULL'
      '           AND rt_fechabaja IS NULL'
      '           AND rt_iddetallenomina = dw_id) esop,'
      '       dw_id'
      '  FROM hys.hdw_detallenominaweb'
      ' WHERE dw_idcabeceranomina ='
      '                       (SELECT cw_id'
      '                          FROM hys.hcw_cabeceranominaweb'
      
        '                         WHERE cw_idestablecimientoweb = :idesta' +
        'blecimientoweb)'
    ...
    ParamData = <
      item
        DataType = ftUnknown
        Name = 'idestablecimientoweb'
        ParamType = ptInput
      end>
  end
  object sdqEsop: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    SQL.Strings = (
      'SELECT rg_esop || '#39' '#39' || rg_sufijoesop esop, rg_descripcion,'
      '       rt_iddetallenomina'
      '  FROM art.prg_riesgos, hys.hrt_riestrabweb'
      ' WHERE rt_idriesgo = rg_id'
      '   AND rg_fechabaja IS NULL'
      '   AND rt_fechabaja IS NULL'
      '   AND rt_iddetallenomina = :iddetallenomina')
    Left = 16
    Top = 392
    ParamData = <
      item
        DataType = ftUnknown
        Name = 'iddetallenomina'
        ParamType = ptInput
      end>
  end
  object dsEsop: TDataSource
    DataSet = sdqEsop
    Left = 44
    Top = 392
  end
