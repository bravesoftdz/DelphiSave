unit unAdministracionEventosHYS;
...
type
  TfrmAdministracionEventosHYS = class(TfrmAdministracionEventos)
    Label32: TLabel;
...
var
  frmAdministracionEventosHYS: TfrmAdministracionEventosHYS;
...
{$R *.DFM}
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.ClearControls;
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.LoadControls;
begin
  sbScroll.VertScrollBar.Position := 0;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.DoABMHijos;
begin
  inherited;
...
{------------------------------------------------------------------------------}
function TfrmAdministracionEventosHYS.DoABM: Boolean;
begin
  Result := inherited DoABM;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.gbFiltrosEventosAdicionalesClick(Sender: TObject);
begin
  inherited;
  DoOcultarControles;   // si no hago esto, cuando colapso y vuelvo a expandir me vuelve a poner visible el frame de ingreso
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.FormCreate(Sender: TObject);
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.DoOcultarControles;
begin
  fraSE_IDCODIGOINGRESO.Visible := False;
  Labelx2.Visible               := False;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.tbLimpiarClick(Sender: TObject);
begin
  inherited;
  fraSE_IDRESPUESTA.Clear;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.fraSE_IDRESPUESTA_2cmbDescripcionDropDown(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.fraSE_IDRESPUESTA_3cmbDescripcionDropDown(Sender: TObject);
begin
...
procedure DoMostrarEventosAgenda(AContrato: Integer; ACargaDesde: TDateTime = 0; ASoloMiSector: boolean = False);
begin
  with TfrmAdministracionEventosHYS.Create(nil) do
    try
...
{------------------------------------------------------------------------------}
function TfrmAdministracionEventosHYS.Validar: Boolean;
begin
  inherited Validar;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.DoArmarSqlBusquedaAdicional;
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.fraSE_IDRESPUESTA_2PropiedadesChange(Sender: TObject);
begin
  inherited;
  edSE_OBSERVACIONREALIZADO_2.Lines.Add(fraSE_IDRESPUESTA_2.Descripcion);
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.fraSE_IDRESPUESTA_3PropiedadesChange(Sender: TObject);
begin
  inherited;
  edSE_OBSERVACIONREALIZADO.Lines.Add(fraSE_IDRESPUESTA_3.Descripcion);
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.btnAceptarSeleccionClick(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.Filtros(AValue: boolean);
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.btnCerrarClick(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.fraSE_IDMOTIVOEVENTO_ABAJOcmbDescripcionDropDown(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosHYS.frafpSE_IDCODIGOINGRESOPropiedadesChange(Sender: TObject);
begin
  inherited;
end;
{------------------------------------------------------------------------------}
