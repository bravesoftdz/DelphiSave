inherited frmCompensarDeuda: TfrmCompensarDeuda
  Left = 26
  Top = 117
  Caption = 'Compensaci'#243'n de Saldo Acreedor'
  ClientHeight = 370
  ClientWidth = 772
  ...
  inherited CoolBar: TCoolBar
    ...
    inherited ToolBar: TToolBar
      ...
      object tbCompensMasiva: TToolButton
        Left = 370
        Top = 0
        Hint = 'Compensaci'#243'n Masiva'
        ImageIndex = 21
        OnClick = tbCompensMasivaClick
      end
