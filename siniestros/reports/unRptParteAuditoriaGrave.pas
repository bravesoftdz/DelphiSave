...
type
  TrptParteAuditoriaGrave = class(TQuickRep)
...
procedure ImprimirGrave(IdParte, iSiniestro, iOrden, iRecaida: Integer);
...
begin
  with TrptParteAuditoriaGrave.Create(Application) do
  try
