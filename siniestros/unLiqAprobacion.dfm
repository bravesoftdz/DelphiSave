inherited frmLiqAprobacion: TfrmLiqAprobacion
  Left = 460
  Top = 332
  Caption = 'Aprobaci'#243'n de Liquidaciones'
  ClientHeight = 510
  ClientWidth = 807
  ...
  object pnlTop: TPanel [1]
    ...
    object CoolBar: TCoolBar
      ...
      object ToolBar: TToolBar
        ...
        object tbPendiente: TToolButton
          Left = 62
          Top = 0
          Hint = 'Pendiente'
          Caption = 'tbPendiente'
          ImageIndex = 22
          OnClick = tbPendienteClick
        end
        object tbRevisar: TToolButton
          Left = 85
          Top = 0
          Hint = 'Revisi'#243'n (Ctrl+R)'
          Caption = 'tbRevisar'
          ImageIndex = 7
          OnClick = tbRevisarClick
        end
        object tbAdeudaDDJJ: TToolButton
          Left = 108
          Top = 0
          Hint = 'Adeuda DDJJ'
          Caption = 'tbAdeudaDDJJ'
          ImageIndex = 25
          ParentShowHint = False
          ShowHint = True
          OnClick = tbAdeudaDDJJClick
        end
        object tbDerivar: TToolButton
          Left = 131
          Top = 0
          Hint = 'Derivar a GPBA (Ctrl+D)'
          Caption = 'tbDerivar'
          ImageIndex = 46
          OnClick = tbDerivarClick
        end
        object tbGerencia: TToolButton
          Left = 154
          Top = 0
          Hint = 'Gerencia'
          Caption = 'Gerencia'
          ImageIndex = 17
          OnClick = tbGerenciaClick
        end
        ...
        object tbNoAutorizar: TToolButton
          Left = 185
          Top = 0
          Hint = 'No autorizar (Ctrl+N)'
          Caption = 'tbNoAutorizar'
          ImageIndex = 8
          OnClick = tbNoAutorizarClick
        end
    ...
    object gbCodLiq: TGroupBox
      ...
      Width = 132
      Height = 44
      Caption = 'C'#243'digo de liquidaci'#243'n'
      TabOrder = 0
      object edCodLiq: TEdit
        Left = 5
        Top = 16
        Width = 121
        Height = 21
    ...
    object GroupBox4: TGroupBox
      ...
      object chkRevision: TCheckBox
        ...
        Width = 75
        Height = 17
        Caption = 'En revisi'#243'n'
        TabOrder = 0
        OnClick = chkRevisionClick
      end
      object chkDerivadas: TCheckBox
        Left = 4
        Top = 24
        Width = 75
        Height = 13
        Caption = 'Derivadas'
        TabOrder = 1
        OnClick = chkDerivadasClick
      end
      object chkAdeudaDDJJ: TCheckBox
        Left = 80
        Top = 24
        Width = 86
        Height = 13
        Caption = 'Adeuda DDJJ'
        TabOrder = 2
        OnClick = chkAdeudaDDJJClick
      end
      object chkGerencia: TCheckBox
        Left = 80
        Top = 10
        Width = 69
        Height = 13
    ...
    object GroupBox5: TGroupBox
      ...
      object chkAutomaticas: TCheckBox
        Left = 4
        Top = 6
        Width = 78
        Height = 17
        Caption = 'Autom'#225'ticas'
        TabOrder = 0
      end
      object chkSiniestrosRech: TCheckBox
        Left = 4
        Top = 24
        Width = 98
        Height = 17
        Caption = 'Siniestros Rech.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        ...
        ParentFont = False
        TabOrder = 1
        OnClick = chkSiniestrosRechClick
      end
    end
  end
  object PageControl: TPageControl [2]
    ...
    object tsILP: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object Label6: TLabel
          ...
          Width = 212
          Height = 13
          Caption = 'Empresa con deuda - Liquidaci'#243'n autorizable'
        end
        object Label7: TLabel
          ...
          Width = 231
          Height = 13
          Caption = 'Empresa con deuda - Liquidaci'#243'n NO autorizable'
        end
        ...
        object Label8: TLabel
          ...
          Width = 109
          Height = 13
          Caption = 'Empresa adeuda DDJJ'
        end
      end
      object dgILP: TArtDBGrid
        Left = 0
        Top = 33
        Width = 799
        Height = 324
        ...
        TitleFont.Style = []
        OnCellClick = dgILPCellClick
        OnDrawColumnCell = dgILPDrawColumnCell
        OnKeyDown = dgILPKeyDown
        IniStorage = FormStorage
        OnGetCellParams = dgILTGetCellParams
        FooterBand = False
        TitleHeight = 17
        Columns = <
          item
          ...
          item
            Expanded = False
            FieldName = 'le_fecharevisado'
            Title.Caption = 'Fecha Revisado'
            Width = 104
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_fechaadeudaddjj'
            Title.Caption = 'Fecha Adeuda DDJJ'
            Width = 100
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_fechagerencia'
            Title.Caption = 'Fecha Gerencia'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_fechaderivado'
            Title.Caption = 'Fecha Derivado GPBA'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'LE_USUALTA'
            Title.Caption = 'Usuario Liq.'
            Width = 80
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_montopagoadic'
            Title.Caption = 'Pago Adic.'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_montocompdanios'
            Title.Caption = 'Comp. Da'#241'os'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'le_montootrospagos'
    ...
    object tsILT: TTabSheet
      ...
      object dgILT: TArtDBGrid
        ...
        TitleFont.Name = 'MS Sans Serif'
        TitleFont.Style = []
        OnCellClick = dgILTCellClick
        OnDrawColumnCell = dgILTDrawColumnCell
        OnKeyDown = dgILTKeyDown
        IniStorage = FormStorage
        OnGetCellParams = dgILTGetCellParams
        FooterBand = False
        TitleHeight = 17
    ...
    object tsOtrosPagos: TTabSheet
      Caption = 'Otros pagos / Reintegros'
      ImageIndex = 5
      ExplicitLeft = 0
      ExplicitTop = 0
      ExplicitWidth = 0
      ExplicitHeight = 0
      object dgOPagos: TArtDBGrid
        Left = 0
        Top = 37
        Width = 799
        Height = 320
        ...
        TitleFont.Name = 'MS Sans Serif'
        TitleFont.Style = []
        OnCellClick = dgOPagosCellClick
        OnDrawColumnCell = dgOPagosDrawColumnCell
        OnKeyDown = dgOPagosKeyDown
        IniStorage = FormStorage
        FooterBand = False
        TitleHeight = 17
        Columns = <
      ...
      object Panel1: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 1
        object gbVerOP: TGroupBox
          Left = 5
          Top = 1
          Width = 280
          Height = 33
          TabOrder = 0
          object rbVerTodos: TRadioButton
            Left = 8
            Top = 11
            Width = 53
            Height = 17
          ...
          object rbVerReintegros: TRadioButton
            Left = 160
            Top = 11
            Width = 113
            Height = 17
            Caption = 'Reintegros m'#233'dicos'
            TabOrder = 2
          end
        end
        object chkUltAnio: TCheckBox
          Left = 296
          Top = 12
          Width = 95
          Height = 17
          Caption = 'S'#243'lo '#250'ltimo a'#241'o'
          Checked = True
          State = cbChecked
          TabOrder = 1
        end
  ...
  object Seguridad: TSeguridad
    ...
    Claves = <
      ...
      item
        Name = 'LiquidarPrescriptasILT'
      end
      item
        Name = 'LiquidarObservadasILT'
      end
      item
        Name = 'LiquidarDDJJAdeudadasILT'
      end
      item
        Name = 'SuperUser'
      end
      item
        Name = 'AprobarILTEmpresaBloqueada'
      end
      item
        Name = 'VerYAprobLiq_SiniRechazado'
      end
      item
        Name = 'Aprobar_pagoGPBA'
      end>
  ...
  object sdqOPagos: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    AfterOpen = sdqOPagosAfterOpen
    SQL.Strings = (
      
        'SELECT utiles.armar_siniestro(pr_siniestro, pr_orden, pr_recaida' +
        ') siniestro, '
      
        '       pr_numpago, pr_estado, pr_acreedor, utiles.armar_cuit(pr_' +
        'cuitcuil) cuitcuil, '
      
        '       pr_letrafac || '#39'-'#39' || pr_situfac || '#39'-'#39' || pr_numfac fact' +
        'ura, cp_titpago,'
      
        '       pr_femision, pr_fechapago, pr_imporpago, pr_cuitcuil, pr_' +
        'letrafac, '
      '       pr_situfac, pr_numfac'
      '  FROM spr_pagoexpesin, scp_conpago, sex_expedientes'
      ...
      '   AND pr_estado IN('#39'C'#39', '#39'M'#39')'
  ...
  object dsOPagos: TDataSource
    DataSet = sdqOPagos
    Left = 72
    Top = 249
  end
  object sdOPagos: TSortDialog
    Caption = 'Orden'
    DataSet = sdqOPagos
    SortFields = <
      item
      ...
      item
        Title = 'F. emis/anul.'
        DataField = 'pr_femision'
        FieldIndex = 0
      end
      item
        Title = 'Importe'
        DataField = 'pr_imporpago'
        FieldIndex = 0
      end>
    IniStorage = FormStorage
    FixedRows = 0
  ...
  object sdqILT: TSDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT /*+ rule */ afiliacion.get_ultcontrato(em_cuit) contrato,' +
        ' art.utiles.armar_siniestro(le_siniestro, le_orden, le_recaida) ' +
        'siniestro,  le_siniestro, le_orden, le_recaida,'
      
        '       le_numliqui, le_tipoliqui, le_estado,  ex_id, le_fproceso' +
        ', le_fechades, le_fechahas, le_imporperi, tmp_condeuda condeuda,'
      
        '       tmp_deudaactual deudaactual, tmp_cuotapromedio cuotaprome' +
        'dio, cp_titpago descripcion,  le_conpago, em_fechaconcurso mp_fe' +
        'chaconcurso,'
      
        '       em_fechaquiebra mp_fechaquiebra,  co_motivobaja mp_motivo' +
        'baja, co_fechabaja mp_fbaja, ex_cuit, co_contrato,  '
      
        '       art.liq.get_estadoliquidacionilt(le_tipoliqui, le_estado)' +
        ' estado,  art.utiles.armar_cuit(em_cuit) cuit, em_nombre empresa' +
        ',  '
      
        '       art.utiles.armar_cuit(tj_cuil) cuil, tj_nombre trabajador' +
        ',  art.deuda.ilt_autorizable(le_conpago, em_fechaconcurso, em_fe' +
        'chaquiebra, '
      
        '       co_motivobaja,  co_fechabaja, tmp_condeuda, tmp_cobertura' +
        ')  ilt_autorizable,  em_holding, ex_causafin,  '
      
        '       emi.utiles.is_contratoddjj_adeudadas(ex_contrato, TO_CHAR' +
        '(ADD_MONTHS(art.actualdate, -24), '#39'YYYYMM'#39'),  '
      
        '       TO_CHAR(art.actualdate, '#39'YYYYMM'#39')) adeudaddjj, ex_id,  le' +
        '_fecharevisado, le_fechaadeudaddjj, le_fechagerencia, le_id, nul' +
        'l checkbox,'
      '       afiliacion.get_ultcontrato(em_cuit) contrato  '
      
        '  FROM tmp_aprobaciones, scp_conpago, sex_expedientes, aem_empre' +
        'sa,  aco_contrato, sle_liquiempsin, ctj_trabajador  '
      ...
      '   AND le_femision IS NOT NULL  '
      '   AND le_aprobado IS NULL  '
      '   AND NVL(ex_causafin, '#39'0'#39') NOT IN ('#39'02'#39', '#39'95'#39', '#39'99'#39')  '
      '   AND le_tipoliqui IN('#39'L'#39', '#39'D'#39', '#39'J'#39', '#39'R'#39', '#39'X'#39', '#39'Y'#39', '#39'Z'#39')  '
      '   AND le_estado IN('#39'C'#39', '#39'M'#39', '#39'V'#39')'
      ''
      ''
      '')
    Left = 44
  ...
  object ShortCutControl: TShortCutControl
    ShortCuts = <
      ...
      item
        Key = 16462
        LinkControl = tbNoAutorizar
      end
      item
        Key = 16449
        LinkControl = tbAutorizar
      end
      item
        Key = 116
  ...
  object dsILP: TDataSource
    DataSet = sdqILP
    Left = 72
    Top = 305
  end
  object sdqILP: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    AfterOpen = sdqILTAfterOpen
    SQL.Strings = (
