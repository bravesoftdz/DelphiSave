...
uses
  ...
  unAdministracionPresupuestos in 'unAdministracionPresupuestos.pas' {frmAdministracionPresupuestos: TFSForm},
  unAdministracionConceptos in 'unAdministracionConceptos.pas' {frmAdministracionConceptos: TFSForm},
  unDetallePresupuesto in 'unDetallePresupuesto.pas' {frmDetallePresupuesto: TFSForm},
  unArt in '..\..\comunes\unArt.pas',
  unConsultaPresupuesto in 'unConsultaPresupuesto.pas' {frmConsultaPresupuesto: TFSForm},
  unCuentasConcepto in 'unCuentasConcepto.pas' {frmCuentasConcepto: TFSForm},
  unSemaforosConcepto in 'unSemaforosConcepto.pas' {frmSemaforosConcepto: TFSForm},
  unIndicadores in 'unIndicadores.pas' {frmIndicadores: TFSForm},
  unPresupuestoCartera in 'unPresupuestoCartera.pas' {frmPresupuestoCartera: TFSForm},
  ...
  unPresupuestoRRHH in 'unPresupuestoRRHH.pas' {frmPresupuestoRRHH: TFSForm},
