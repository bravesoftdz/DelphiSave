...
uses
  ...
  unCircuitoReconf in 'unCircuitoReconf.pas' {frmCircuitoReconf},
  Explota in 'Explota.pas' {frmExplota},
  unHistoriaClinica in 'unHistoriaClinica.pas' {frmHistoriaClinica},
  ...
  unManMedicos in 'unManMedicos.pas' {frmManMedicos},
  GamaCIIU in 'GamaCIIU.pas' {GamaCIU},
  unManEstudioRiesgo in '..\AMP\Mantenimiento\unManEstudioRiesgo.pas' {frmManEstudioRiesgo},
  unfraCIIU in '..\Comunes\FRAMES\unfraCIIU.pas' {fraCIIU: TFrame},
  unManActividadRiesgo in '..\AMP\Mantenimiento\unManActividadRiesgo.pas' {frmManActividadRiesgo},
  unManEstudios in '..\AMP\Mantenimiento\unManEstudios.pas' {frmManEstudios},
  unfraMedico in '..\AMP\FRAMES\unfraMedico.pas' {fraMedico: TFrame},
  unEstudiosDef in 'unEstudiosDef.pas' {frmEstudioDef},
  unEstAudiometria in 'unEstAudiometria.pas' {frmEstAudiometria},
  unMoldeAbmAnalisis in 'unMoldeAbmAnalisis.pas' {frmMoldeAbmAnalisis},
  BinUtils in '..\..\Comunes\BinUtils.pas',
  unFormEstudios in 'unFormEstudios.pas',
  unEstRespiratorio in 'unEstRespiratorio.pas' {frmEstRespiratorio},
  ...
  unFraTipoEstudio in 'FRAMES\unFraTipoEstudio.pas' {fraTipoEstudio: TFrame},
  ...
  unFraReconfirmacion in 'FRAMES\unFraReconfirmacion.pas' {fraReconfirmacion: TFrame},
  unCustomGridABM in '..\Comunes\REPOSIT\unCustomGridABM.pas' {frmCustomGridABM},
  unSegRecEstudios in 'unSegRecEstudios.pas' {frmSegRecEstudios},
  unMoverEstudio in 'unMoverEstudio.pas' {frmMoverEstudio},
  unRptEncabezado in 'REPORTS\unRptEncabezado.pas' {rptEncabezado: TQuickRep},
  unRptAudiometria in 'REPORTS\unRptAudiometria.pas' {rptAudiometria: TQuickRep},
  unManCtbTablas in '..\Comunes\Forms\unManCtbTablas.pas' {frmManCtbTablas},
  unManCtbTablasAMP in '..\AMP\Mantenimiento\unManCtbTablasAMP.pas' {frmManCtbTablasAMP},
  unConsEstTipPeriodoClick in 'CONSULTA\unConsEstTipPeriodoClick.pas' {frmConsEstTipPeriodoClick},
  unMotivoEstudio in 'unMotivoEstudio.pas' {frmMotivoEstudio},
  ...
  unFraFacturaAMP in 'FRAMES\unFraFacturaAMP.pas' {fraFacturaAMP: TFrame},
  ...
  unRptNotaDebitoAMP in 'REPORTS\unRptNotaDebitoAMP.pas' {rptNotaDebito: TQuickRep},
  ...
  unManPRG_RIESGOS in '..\HYS\ABM\unManPRG_RIESGOS.pas' {frmManPRG_RIESGOS},
  unGenLotesAMP in 'unGenLotesAMP.pas' {frmGenLotesAMP},
  ...
  unRptInformeAPrestador in 'reports\unRptInformeAPrestador.pas' {rptInformeAPrestador},
  unRptInformeAEmpresa in 'reports\unRptInformeAEmpresa.pas' {rptInformeAEmpresa},
  unfraPrestadorAMPCuit in 'frames\unfraPrestadorAMPCuit.pas' {fraPrestadorAMPCuit: TFrame},
  unfraPrestadorAMP in 'frames\unfraPrestadorAMP.pas' {fraPrestadorAMP: TFrame},
  unSeguimientoLote in 'unSeguimientoLote.pas' {frmSeguimientoLote},
  ...
  unSeguimientoEstudios in 'unSeguimientoEstudios.pas' {frmSeguimientoEstudios},
  unSeguimientoPQ in 'unSeguimientoPQ.pas' {frmSeguimientoPQ},
  unListaEMail in 'unListaEMail.pas' {frmListaEMail},
  unManMotivosRechazo in 'unManMotivosRechazo.pas' {frmManMotivosRechazo},
  unManMotivosBaja in 'unManMotivosBaja.pas' {frmManMotivosBaja},
  unElementosEnviados in '..\comunes\forms\unElementosEnviados.pas',
  unRptInformeMovilSanitario in 'reports\unRptInformeMovilSanitario.pas' {rptInformeMovilSanitario},
  unConsExpConsolidada in 'unConsExpConsolidada.pas' {frmConsExpConsolidada},
  unObsLote in 'unObsLote.pas' {frmObsLote},
  ...
  unConsEstabCUIT in 'unConsEstabCUIT.pas' {frmConsEstabCUIT},
  unRptReclamoEstudios in 'reports\unRptReclamoEstudios.pas' {rptReclamoEstudios},
  unObsSubLote in 'unObsSubLote.pas' {frmObsSubLote},
  unRptCartaDocTrabAusentes in 'reports\unRptCartaDocTrabAusentes.pas' {rptCartaDocTrabAusentes},
  ...
  unManCTB_CODRE in '..\comunes\forms\unManCTB_CODRE.pas' {frmManCTB_CODRE: TFSForm},
  ...
  TBL_PerdAudi2 in 'TBL_PerdAudi2.pas',
  unManCtbUbicGeograficas in 'unManCtbUbicGeograficas.pas' {frmManCtbUbicGeograficas: TFSForm},
  ...
  unConsRelevExpuestos in 'consulta\unConsRelevExpuestos.pas' {frmConsExpuestos: TFSForm},
  unArt in '..\..\Comunes\unArt.pas',
  unAlarmas in '..\..\Comunes\unAlarmas.pas',
  unAMPAdministracionCartas in 'unAMPAdministracionCartas.pas' {frmAMPAdministracionCartas: TFSForm},
  VCLExtra in '..\..\Comunes\VCLExtra.pas',
  unEmpresa in '..\..\Comunes\interfaces\unEmpresa.pas',
  unAbmAnalisis in 'unAbmAnalisis.pas' {frmAbmAnalisis},
  unRptPersonalExtra in 'reports\unRptPersonalExtra.pas' {rptPersonalExtra},
  unRptLotesACerrar in 'reports\unRptLotesACerrar.pas' {rptLotesACerrar},
  unManTransicionEstados in '..\amp\mantenimiento\unManTransicionEstados.pas' {frmManTransicionEstados: TFSForm},
  unManEstadosLote in '..\amp\mantenimiento\unManEstadosLote.pas' {frmManEstadosLote: TFSForm},
  ...
  unRptInformeGenAMP in 'reports\unRptInformeGenAMP.pas' {rptInformeGenAMP},
  ...
  unRptInformeGenAMPDet in 'reports\unRptInformeGenAMPDet.pas' {rptInformeGenAMPDet},
  unUtilsArchivo in '..\archivo_new\unUtilsArchivo.pas',
  unObsAsigLote in 'unObsAsigLote.pas' {frmObsAsigLote: TFSForm},
  OneInstance in '..\..\comunes\OneInstance.pas',
  unManEstudiosAsociados in '..\amp\mantenimiento\unManEstudiosAsociados.pas' {frmManEstudiosAsociados: TFSForm},
  unManPerfilesAMP in 'unManPerfilesAMP.pas' {frmManPerfilesAMP: TFSForm},
  unManUsuarioPerfilAMP in 'unManUsuarioPerfilAMP.pas' {frmManUsuariosPerfilesAMP},
  unGestionReconfirmacion in 'unGestionReconfirmacion.pas' {frmGestionReconfirmacion: TFSForm},
  unSegReconfirmaciones in 'unSegReconfirmaciones.pas' {frmSegReconfirmaciones: TFSForm},
  unQrLibreDeuda in '..\cobranzas\reports\unQrLibreDeuda.pas' {qrLibreDeuda: TQuickRep},
  unGenLotesReconf in 'unGenLotesReconf.pas' {frmGenLotesReconf: TFSForm},
  unRptInformeGenReconfDet in 'reports\unRptInformeGenReconfDet.pas' {rptInformeGenReconfDet},
  ...
  unProtPosForzadas in 'unProtPosForzadas.pas' {frmProtPosForzadas: TFSForm},
  unObsReconfirmacion in 'unObsReconfirmacion.pas' {frmObsReconf: TFSForm},
  unAgendaTelefonica in '..\comunes\forms\unAgendaTelefonica.pas' {frmAgendaTelefonica: TFSForm},
  unRptInfEmpresaReconf in 'reports\unRptInfEmpresaReconf.pas' {rptInfEmpresaReconf},
  unRptInfPrestadorReconf in 'reports\unRptInfPrestadorReconf.pas' {rptInfPrestadorReconf},
  unAfiliaciones in '..\afiliaciones\unAfiliaciones.pas',
  unRptNotifAusentesPrest in 'reports\unRptNotifAusentesPrest.pas' {rptNotifAusentesPrest},
  ...
  unManObservacionesSubLotes in 'unManObservacionesSubLotes.pas' {frmManObservacionesSubLotes: TFSForm},
  unListadoRecepcion in 'unListadoRecepcion.pas' {frmListadoRecepcion: TFSForm},
  unrptListadoRecepcion in 'unrptListadoRecepcion.pas' {rptListadoRecepcion},
  unProcesosRecepcion in 'unProcesosRecepcion.pas' {frmProcesosRecepcion: TFSForm},
  ...
  unEmpresaNotificada in 'unEmpresaNotificada.pas' {frmEmpresaNotificada: TFSForm},
  unImpoExpoUtils in '..\impoexpo\unImpoExpoUtils.pas',
  unGestionRelevamientosExpuestos in 'unGestionRelevamientosExpuestos.pas' {frmGestionRelevamientosExpuestos: TFSForm},
  unComunesAMP in 'unComunesAMP.pas',
  unRptInformeAsigLoteEmpresa in 'reports\unRptInformeAsigLoteEmpresa.pas' {rptInformeAsigLoteEmpresa},
  ...
  unCotizacionHYS in 'unCotizacionHYS.pas' {frmCotizacionHYS: TFSForm},
  ...
  unEstExamPeriodORL in 'unEstExamPeriodORL.pas' {frmEstExamenORL},
  ...
  unManPrestadorContrato in 'unManPrestadorContrato.pas' {frmManPrestadorContrato: TFSForm},
  ...
  unrptReclamoNominaEmpresa in 'unrptReclamoNominaEmpresa.pas' {rptReclamoNominaEmpresa},
  unManEstadoPresentacion in 'unManEstadoPresentacion.pas' {frmManEstadoPresentacion: TFSForm},
  unManCausa in 'unManCausa.pas' {frmManCausa: TFSForm},
  unManAsigPrestaFijo in 'unManAsigPrestaFijo.pas' {frmManAsigPrestaFijo: TFSForm},
...
begin
  ...
  Application.Title := 'Administración Análisis Médicos Periódicos';
