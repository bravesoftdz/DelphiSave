inherited frmManAPC_PERMITECLONACION: TfrmManAPC_PERMITECLONACION
  Left = 204
  Top = 139
  Width = 700
  Height = 440
  Caption = 'Mantenimiento de Estados para Clonaci'#243'n'
  ...
  object Label1: TLabel [0]
    ...
    Width = 174
    Height = 13
    Caption = 'Estados con permisos a clonar'
