inherited fraEmpresaAGENDA: TfraEmpresaAGENDA
  Width = 509
  Height = 57
  ExplicitWidth = 509
  ExplicitHeight = 57
  ...
  object btnClear: TJvSpeedButton [6]
    Left = 481
    Top = 27
    Width = 22
    Height = 22
  ...
  object sdqMensajes: TSDQuery
    ...
    SQL.Strings = (
      ...
      '                                 AND ad_autorizado = '#39'S'#39'))'
        ...
        '       || (SELECT CASE WHEN ad_fechavigencia IS NULL THEN '#39#39' ELS' +
        'E'
      
        '                  '#39'Tenga en cuenta que se podr'#225'n emitir Certific' +
        'ados de Cobertura para esta empresa hasta el '#39
      
        '                  || TO_CHAR (MAX(ad_fechavigencia), '#39'dd/mm/yyyy' +
        #39')'
  ...
  object TimerInformacionAdicional: TTimer
    Enabled = False
    Interval = 100
    OnTimer = TimerInformacionAdicionalTimer
    Left = 240
    Top = 16
  end
end
