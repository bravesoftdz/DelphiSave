  ...
  object sdqMensajes: TSDQuery
    ...
    SQL.Strings = (
      ...
      '              AND co_estado <> '#39'13'#39')'
        ...
        'ura con cl'#225'usula, '#39
      '                  || CHR (13)'
      '                  || CHR (10)'
      '                  || '#39'ya que la empresa tiene una deuda de: $ '#39
      '                  || TO_CHAR (ROUND (deuda, 2))'
      '                  || CHR (13)'
      '                  || CHR (10)'
      '                  || CHR (13)'
      '                  || '#39'Deber'#225' comunicarse con el sector '#39
      
        '                  || DECODE (co_idestudio, NULL, '#39'COBRANZAS'#39', '#39'L' +
        'EGALES'#39')'
      '                  || '#39'.'#39
      '                  || CHR (13)'
      '                  || CHR (10)'
