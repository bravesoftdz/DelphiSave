  ...
  object AdvToolBarPager: TAdvToolBarPager
    ...
    object AdvPage: TAdvPage
      ...
      object edMemo: TRichEdit
        ...
        Font.Style = []
        Lines.Strings = (
          'Importaci'#243'n de Movimientos Manuales (Archivo *.csv)'
          ''
          'Formato del archivo'
          '-------------------------------'
          'N'#186'Contrato (num'#233'rico)'
          'Per'#237'odo (alfanum'#233'rico - 6 caracteres)'
          'C'#243'digo de Movimiento (alfanum'#233'rico)'
          'Importe (real)'
          'Observaciones (alfanum'#233'rico)')
        ParentFont = False
        ReadOnly = True
        TabOrder = 0
        WantTabs = True
