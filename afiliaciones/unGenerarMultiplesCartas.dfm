inherited frmGenerarMultiplesCartas: TfrmGenerarMultiplesCartas
  Left = 309
  Top = 203
  Width = 640
  Height = 480
  ...
  inherited pnlFiltros: TPanel
    ...
    object edContratos: TFilenameEdit
      Left = 60
      Top = 104
      Width = 532
      Height = 21
    ...
    object edArchivo: TFilenameEdit
      ...
      Width = 532
      Height = 21
      OnAfterDialog = edArchivoAfterDialog
    ...
    object ToolBar2: TToolBar
      ...
      ShowHint = True
      TabOrder = 10
      object tbQuitarArchivo: TToolButton
        Left = 0
        Top = 0
        Hint = 'Quitar archivo'
        Caption = 'tbFormatoContrato'
        ImageIndex = 39
        OnClick = tbQuitarArchivoClick
      end
    end
  end
