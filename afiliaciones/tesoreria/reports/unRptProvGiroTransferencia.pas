    ...
    try
      ...
      if not sdqDatos.Eof then
        begin
          ...
          ReportTitle := Iif(Tipo = 'G', 'Banco Prov. Giros y Transf.', 'Banco Prov. Interdepósitos');
          qrlTitTipo.Caption     := Iif(Tipo = 'G', 'GIROS Y TRANSFERENCIAS', 'INTERDEPOSITOS');
          qrlTextoInf.Caption    := Iif(Tipo = 'G', 'SE AUTORIZA A DEBITAR LOS GASTOS DE ESTA OPERATORIA DE NUESTRA CUENTA CORRIENTE Nª 45338/5.', 'Los importes detallados ya cuentan con gastos de comisión incluídos.');
