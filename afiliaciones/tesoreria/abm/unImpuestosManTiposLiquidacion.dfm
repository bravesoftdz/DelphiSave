inherited frmImpuestosManTiposLiquidacion: TfrmImpuestosManTiposLiquidacion
  Width = 469
  Height = 500
  Caption = 'Tipos de Liquidaciones'
  ...
  inherited sdqConsulta: TSDQuery
    SQL.Strings = (
      'SELECT IT_DESCRIPCION, TRUNC(IT_FECHABAJA) FECHABAJA, IT_ID ID'
