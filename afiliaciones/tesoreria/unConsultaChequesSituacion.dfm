inherited frmConsultaChequesSituacion: TfrmConsultaChequesSituacion
  Left = 350
  Top = 372
  BorderIcons = [biSystemMenu]
  Caption = 'Listado de Cheques por Situaci'#243'n'
  ClientHeight = 111
  ClientWidth = 612
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object grpFechaSituacion: TGroupBox [0]
    Tag = 12
    Left = 406
    Top = 40
    Width = 202
  ...
  object grpSituacion: TGroupBox [1]
    Left = 4
    Top = 40
    Width = 398
    Height = 41
    ...
    DesignSize = (
      398
      41)
    inline fraSituacion: TfraCtbTablas
      Left = 5
      Top = 13
      Width = 389
      Height = 23
  ...
  object rptChequeSit: TQuickRep [4]
    Left = -4
    Top = 148
    Width = 1056
    Height = 816
    ...
    PrintIfEmpty = True
    ReportTitle = 'Cheques por Situaci'#243'n'
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object grpMetodoPago: TGroupBox [5]
    Left = 4
    Top = 0
    Width = 398
    Height = 41
    ...
    DesignSize = (
      398
      41)
    object cmbMetodoPago: TArtComboBox
      Left = 6
      Top = 13
      Width = 387
      Height = 21
  ...
  object sdqMetodoPagoFiltro: TSDQuery
    ...
    Options = []
    SQL.Strings = (
      '  SELECT DISTINCT ACS.ATTRIBUTE2 DESCRIPTION'
