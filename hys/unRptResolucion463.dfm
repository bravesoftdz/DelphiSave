object rptResolucion463: TrptResolucion463
  Left = 140
  Top = 126
  Width = 907
  Height = 704
  HorzScrollBar.Position = 12
  VertScrollBar.Position = 1475
  Color = clBtnFace
  ...
  object qrResolucion: TQuickRep
    ...
    object QRBand2: TQRBand
      ...
      object qrFechaFormulario: TQRLabel
        Left = 44
        Top = 6
        Width = 81
        Height = 16
  ...
  object qrPieReporte: TQuickRep
    ...
    object ChildBand5: TQRChildBand
      ...
      object qrResponsableHyS: TQRLabel
        Left = 431
        Top = 368
        Width = 217
        Height = 12
  ...
  object sdqEmpresa: TSDQuery
    ...
    SQL.Strings = (
        ...
        'pcion, DECODE(il_cumplimiento, '#39'S'#39', '#39'X'#39', '#39#39') AS sicump,'
      
        '         DECODE(il_cumplimiento, '#39'N'#39', '#39'X'#39', '#39#39') AS nocump, DECODE' +
        '(il_cumplimiento, '#39'X'#39', '#39'X'#39', '#39#39') AS noapcump,'
      
        '         il_fecharegularizacion, ia_sololectura, --ia_normativa,' +
        ' ia_normativabis,'
      ...
      '           WHEN LENGTH(NVL(ia_normativabis, 0)) <= 40 THEN NULL'
        ...
        '         END AS ia_normativabis2,  art.hys.is_itemeditable(rl_id' +
        ',  ia_id) editable'
