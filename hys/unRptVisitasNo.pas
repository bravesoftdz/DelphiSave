...
type
  ...
  public
    ...
    procedure VistaPrevia(pCuit, pNroEstablecimiento,
      ...
      pLocalidad, pCpa, pProvincia, pTelfax,
      pEmail: String;
      FiltroFechaRegularizacion : Boolean = False;
      pPath : String = '');
    ...
    procedure ExportPdf(pCuit, pNroEstablecimiento,
      ...
      pLocalidad, pCpa, pProvincia, pTelfax,
      pEmail: String;
      FiltroFechaRegularizacion : Boolean;
      pPath : String);
    { Public declarations }
  end;
...
var
  ...
  sCumplimiento, sCump, sNoAplica, faRegularizacion : String;
begin
  try
    ...
    // Ticket 67539
    if FiltroFechaRegularizacion then
    begin
      faRegularizacion := ' AND il_fecharegularizacion <= LAST_DAY (SYSDATE) ';
      sdqReporte.SQL.Text := sdqReporte.SQL.Text + faRegularizacion;
      sSQLitem := sSQLitem + faRegularizacion;
    end;
