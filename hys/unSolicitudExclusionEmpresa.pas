...
begin
  ...
  {Ticket 66192. fraEstadoSolicitudExclusion
      Nuevo Control para poner el estado de la Exclusión,
      y de esa forma excluir de los tableros solo aquellas
      para las cuales la SRT haya aceptado el pedido.
      Los estados serían 3: Pendiente, Aprobado y Rechazado. }
