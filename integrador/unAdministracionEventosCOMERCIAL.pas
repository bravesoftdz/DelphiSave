unit unAdministracionEventosCOMERCIAL;
...
uses
  ...
  JvComponent, JvButton, JvTransparentButton, CardinalEdit;

type
  TfrmAdministracionEventosCOMERCIAL = class(TfrmAdministracionEventos)
    Label32: TLabel;
...
var
  frmAdministracionEventosCOMERCIAL: TfrmAdministracionEventosCOMERCIAL;
...
{$R *.DFM}
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.ClearControls;
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.LoadControls;
begin
  sbScroll.VertScrollBar.Position := 0;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.DoABMHijos;
begin
  inherited;
...
{------------------------------------------------------------------------------}
function TfrmAdministracionEventosCOMERCIAL.DoABM: Boolean;
begin
  Result := inherited DoABM;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.gbFiltrosEventosAdicionalesClick(Sender: TObject);
begin
  inherited;
  DoOcultarControles;   // si no hago esto, cuando colapso y vuelvo a expandir me vuelve a poner visible el frame de ingreso
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.FormCreate(Sender: TObject);
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.DoOcultarControles;
begin
  fraSE_IDCODIGOINGRESO.Visible := False;
  Labelx2.Visible               := False;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.tbLimpiarClick(Sender: TObject);
begin
  inherited;
  fraSE_IDRESPUESTA.Clear;
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.fraSE_IDRESPUESTA_2cmbDescripcionDropDown(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.fraSE_IDRESPUESTA_3cmbDescripcionDropDown(Sender: TObject);
begin
...
procedure DoMostrarEventosAgenda(AContrato: Integer; ACargaDesde: TDateTime = 0; ASoloMiSector: boolean = False);
begin
  with TfrmAdministracionEventosCOMERCIAL.Create(nil) do
    try
...
{------------------------------------------------------------------------------}
function TfrmAdministracionEventosCOMERCIAL.Validar: Boolean;
begin
  inherited Validar;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.DoArmarSqlBusquedaAdicional;
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.fraSE_IDRESPUESTA_2PropiedadesChange(Sender: TObject);
begin
  inherited;
  edSE_OBSERVACIONREALIZADO_2.Lines.Add(fraSE_IDRESPUESTA_2.Descripcion);
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.fraSE_IDRESPUESTA_3PropiedadesChange(Sender: TObject);
begin
  inherited;
  edSE_OBSERVACIONREALIZADO.Lines.Add(fraSE_IDRESPUESTA_3.Descripcion);
end;
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.btnAceptarSeleccionClick(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.Filtros(AValue: boolean);
begin
  inherited;
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.btnCerrarClick(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
procedure TfrmAdministracionEventosCOMERCIAL.fraSE_IDMOTIVOEVENTO_ABAJOcmbDescripcionDropDown(Sender: TObject);
begin
