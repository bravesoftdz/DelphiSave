...
type
  ...
  public
    procedure Preparar(Contrato: Integer; ConTope: Boolean; Imprimir : Boolean);
  end;
...
procedure TqrRNSMultiPeriodo.Preparar(Contrato : Integer; ConTope : Boolean; Imprimir : Boolean);
begin
  try
