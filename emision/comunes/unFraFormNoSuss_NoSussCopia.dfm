object fraFormNoSuss_NoSussCopia: TfraFormNoSuss_NoSussCopia
  Left = 0
  Top = 0
  Width = 428
  Height = 183
  ...
  object gbNotaRelacionada: TGroupBox
    Left = 0
    Top = 139
    Width = 428
    Height = 44
    Align = alBottom
    Caption = 'Nota Relacionada'
    TabOrder = 5
