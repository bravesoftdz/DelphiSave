inherited frmEmpresasTipoPresentacion: TfrmEmpresasTipoPresentacion
  Left = 149
  Top = 109
  Width = 754
  Height = 476
  Caption = 'Empresas y modo de presentaci'#243'n de DDJJ'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Grid: TArtDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'EP_PERIODOVIGENCIADESDE'
      ...
      item
        Expanded = False
        FieldName = 'EP_PERIODOVIGENCIAHASTA'
  ...
  inherited fpAbm: TFormPanel
    ...
    object lblModoPresentacion: TLabel [4]
      Left = 10
      Top = 54
      Width = 95
      Height = 13
      Caption = 'Modo Presentaci'#243'n:'
    end
    ...
    inline fraEmpresaModoPresentacion: TfraEmpresa
      Left = 38
      Top = 20
      Width = 534
      Height = 21
      ...
      ShowHint = True
      TabOrder = 0
      OnExit = fraEmpresaModoPresentacionExit
    ...
    inline fraModoPresentacion: TfraCodigoDescripcionExt
      Left = 110
      Top = 49
      Width = 462
      Height = 23
  ...
  inherited sdqConsulta: TSDQuery
    SQL.Strings = (
        ...
        'SELECT iep.ep_id, aco.co_contrato, iep.ep_periodovigenciahasta, ' +
        'iep.ep_periodovigenciadesde, iep.ep_fechaalta, iep.ep_usualta,'
      
        '       iep.ep_fechabaja, iep.ep_usubaja, aco.co_idempresa, aem.e' +
        'm_id, aem.em_cuit, aem.em_nombre, mp_descripcion, ep_idmodoprese' +
        'ntacion'
      
        '  FROM afi.aem_empresa aem, afi.aco_contrato aco, emi.imp_modopr' +
        'esentacion, emi.iep_empresamodopresentacion iep'
