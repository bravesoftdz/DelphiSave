inherited frmEmpresasSinFondoHip: TfrmEmpresasSinFondoHip
  Left = 140
  Top = 144
  Width = 754
  Height = 476
  Caption = 'Mantenimiento de Empresas con Omisi'#243'n de Fondo Hip.'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Grid: TArtDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'EF_PERIODOVIGENCIADESDE'
      ...
      item
        Expanded = False
        FieldName = 'EF_PERIODOVIGENCIAHASTA'
      ...
      item
        Expanded = False
        FieldName = 'EF_FECHAALTA'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'EF_USUALTA'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'EF_FECHABAJA'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'EF_USUBAJA'
        Visible = False
      end
      item
        Expanded = False
  ...
  inherited fpAbm: TFormPanel
    ...
    inline fraEmpresaSinFondo: TfraEmpresa
      Left = 38
      Top = 20
      Width = 534
      Height = 21
  ...
  inherited sdqConsulta: TSDQuery
    SQL.Strings = (
        ...
        ' SELECT ief.ef_id, aco.co_contrato, ief.ef_periodovigenciahasta,' +
        ' ief.ef_periodovigenciadesde, ief.ef_fechaalta, ief.ef_usualta, '
      
        '                           ief.ef_fechabaja, ief.ef_usubaja, aco' +
        '.co_idempresa, aem.em_id, aem.em_cuit, aem.em_nombre '
      
        'FROM afi.aem_empresa aem, afi.aco_contrato aco, emi.ief_empresaf' +
        'ondo ief '
      'WHERE (aem.em_id = aco.co_idempresa) '
      '                AND (aem.em_id = ief.ef_idempresa) '
      
        '                AND (co_contrato = art.afiliacion.get_ultcontrat' +
        'o(aem.em_cuit)) '
      '   AND 1= 2'
      '')
  end
