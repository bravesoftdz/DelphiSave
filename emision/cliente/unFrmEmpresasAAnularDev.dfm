inherited frmEmpresasAAnularDev: TfrmEmpresasAAnularDev
  Left = 46
  Top = 118
  Width = 680
  Height = 450
  Caption = 'Mantenimiento de empresas a anular devengado'
  ...
  inherited fpAbm: TFormPanel
    ...
    Width = 581
    Height = 225
    Caption = 'Agregar empresas a anular'
    ...
    inline fraEmpresaAAnular: TfraEmpresa
      Left = 38
      Top = 20
      Width = 534
      Height = 21
  ...
  inherited sdqConsulta: TSDQuery
    SQL.Strings = (
        ...
        '       iea.ea_fechabaja, iea.ea_usubaja, aco.co_idempresa, aem.e' +
        'm_id, aem.em_cuit, aem.em_nombre, ea_tipoanulacion,'
      
        '       DECODE(ea_tipoanulacion, '#39'F'#39', '#39'Fija'#39', '#39'V'#39', '#39'Variable'#39', '#39#39 +
        ') descanul, ea_aplica,'
      
        '       DECODE(ea_aplica, '#39'C'#39', '#39'Cuota Solamente'#39', '#39'A'#39', '#39'Cuota y F' +
        'ondo'#39', '#39#39') descaplica, ea_fijocuota, ea_fijofondo,'
      '       ea_anulacionant'
