inherited frmEmpresasNoSdoAcre: TfrmEmpresasNoSdoAcre
  Left = 140
  Top = 144
  Width = 754
  Height = 476
  Caption = 'Empresas que no corresponde Sdo. Acreedor'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited fpAbm: TFormPanel
    ...
    inline fraEmpresaNoSdoAcre: TfraEmpresa
      Left = 38
      Top = 20
      Width = 534
      Height = 21
  ...
  inherited sdqConsulta: TSDQuery
    SQL.Strings = (
        ...
        '                iea.ea_fechabaja, iea.ea_usubaja, aco.co_idempre' +
        'sa, aem.em_id, aem.em_cuit, aem.em_nombre '
      
        'FROM afi.aem_empresa aem, afi.aco_contrato aco, emi.iea_empresac' +
        'orrespsdoacr iea '
