inherited rptCartaSituacionFacturacion: TrptCartaSituacionFacturacion
  Functions.DATA = (
    '0'
    '0'
    #39#39
  ...
  inherited qrbDetail: TQRBand
    Size.Values = (
      259.291666666666700000
      2058.458333333333000000)
    inherited qrrTexto: TQRRichText
      Size.Values = (
  ...
  inherited qrbPageFooter: TQRBand
    ...
    object QRLabel7: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'Direcci'#243'n Insuficiente'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -9
    ...
    object QRCheckBox1: TQRCheckBox
      Left = 241
      Top = 76
      Width = 11
      Height = 11
    ...
    object QRCheckBox2: TQRCheckBox
      Left = 241
      Top = 93
      Width = 11
      Height = 11
    ...
    object QRCheckBox3: TQRCheckBox
      Left = 241
      Top = 112
      Width = 11
      Height = 11
    ...
    object QRCheckBox4: TQRCheckBox
      Left = 241
      Top = 129
      Width = 11
      Height = 11
    ...
    object QRLabel11: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'Direcci'#243'n Inexistente'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -9
    ...
    object QRCheckBox5: TQRCheckBox
      Left = 382
      Top = 76
      Width = 11
      Height = 11
    ...
    object QRCheckBox6: TQRCheckBox
      Left = 382
      Top = 93
      Width = 11
      Height = 11
    ...
    object QRCheckBox7: TQRCheckBox
      Left = 382
      Top = 112
      Width = 11
      Height = 11
    ...
    object QRContratoCuitBarCode: TArtQRLabel
      Left = 129
      Top = 5
      Width = 485
      Height = 26
      ...
      Font.Style = []
      OnPrint = QRContratoCuitBarCodePrint
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 22
    end
    object QRContratoCuit: TArtQRLabel
      Left = 129
      Top = 30
      Width = 485
      Height = 17
