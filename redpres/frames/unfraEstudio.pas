...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, unFraCodigoDescripcion, Db, PatternEdit,
  StdCtrls, Mask, ToolEdit, ArtComboBox, SDEngine, RxToolEdit;
...
begin
  ...
  FExtraFields    := ', ES_COSTO, ES_UMEDIDA, ES_MAXIMO, ES_MINIMO, ES_FORMULARIO ';
//  FExtraCondition := '';
