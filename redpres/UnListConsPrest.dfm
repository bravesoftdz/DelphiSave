inherited frmConsPrest: TfrmConsPrest
  Left = 375
  Top = 155
  ...
  object dbgDatos: TArtDBGrid [0]
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'TI'
        Title.Alignment = taCenter
        Title.Caption = 'Terapia Intensiva'
        Width = 102
        Visible = True
      end
      item
        ...
        FieldName = 'UCO'
        Title.Alignment = taCenter
        Title.Caption = 'Unidad Coronaria'
        Width = 102
        Visible = True
      end
      item
        ...
        FieldName = 'AUTI'
        Title.Alignment = taCenter
        Title.Caption = 'Aislam. Unid. Coronaria'
        Width = 142
        Visible = True
      end
      item
      ...
      item
        ...
        FieldName = 'CONEX'
        Title.Alignment = taCenter
        Title.Caption = 'Consultorios Externos'
        Width = 131
        Visible = True
      end
      item
        ...
        Title.Caption = 'Reclamos D'#233'bitos'
        Width = 121
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Contr. Mutual Vig.'
        Width = 88
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Caption = 'Vencimiento de la pr'#243'xima cuota'
        Width = 82
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Desde guardia activa'
        Width = 75
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hasta guardia activa'
        Width = 75
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Desde guardia pasiva'
        Width = 75
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hasta guardia pasiva'
        Width = 75
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Guardia activa Esp.'
        Width = 60
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Desde guardia activa Esp.'
        Width = 80
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hasta guardia activa Esp.'
        Width = 75
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Guardia pasiva Esp.'
        Width = 60
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Desde guardia pasiva Esp.'
        Width = 76
        Visible = True
      end
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Hasta guardia pasiva Esp.'
        Width = 76
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Caption = 'Tipo de Poliza'
        Width = 100
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'COMPASEGURADORA'
        Title.Caption = 'Comp. Aseguradora'
        Width = 150
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Caption = 'Visado Doc.'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'estadolegajo'
        Title.Caption = 'Estado Legajo'
        Width = 150
        Visible = True
      end>
  end
  object CoolBar: TCoolBar [1]
    ...
    object ToolBar: TToolBar
      ...
      object tbEstadoLegajos: TToolButton
        Left = 161
        Top = 0
        Hint = 'Ver Estado Legajos'
        Caption = 'Ver Estado Legajos'
        ImageIndex = 9
        ParentShowHint = False
        ShowHint = True
        Style = tbsCheck
  ...
  object pcFiltros: TPageControl [2]
    ...
    object tsFiltros0: TTabSheet
      ...
      object Label11: TLabel
        ...
        Height = 13
        Anchors = [akTop, akRight]
        Caption = 'Estado Seg.mala praxis'
      end
      ...
      object chkSinEspecialidad: TCheckBox
        Left = 314
        Top = 95
        Width = 93
        Height = 14
        Anchors = [akTop, akRight]
        Caption = 'Sin Especialidad'
        TabOrder = 1
        OnClick = chkSinEspecialidadClick
      end
      ...
      inline fraEstadoSeguro: TfraCtbTablas
        Left = 579
        Top = 101
        Width = 171
        Height = 23
    ...
    object tsFiltros1: TTabSheet
      ...
      object cmbProvincia: TArtComboBox
        Left = 323
        Top = 14
        Width = 181
        Height = 21
      ...
      object gbDatosContratos: TGroupBox
        Left = 1
        Top = 46
        Width = 424
        Height = 79
        Caption = ' Datos de Legajo'
        TabOrder = 4
        ...
        object chkRenovAutom: TCheckBox
          Left = 4
          Top = 12
          Width = 114
          Height = 17
          Hint = 'Renovaci'#243'n autom'#225'tica'
          Caption = 'Renov. Autom'#225'tica'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object chkContrCargados: TCheckBox
          Left = 4
          Top = 28
          Width = 69
          Height = 17
          Hint = 'Contratos Cargados'
          Caption = 'Cargados'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 3
        end
        object chkContrVencidos: TCheckBox
          Left = 234
          Top = 28
          Width = 63
          Height = 17
        ...
        object chkActaAutoridades: TCheckBox
          Left = 135
          Top = 28
          Width = 81
          Height = 17
          Hint = 'Acta de designaci'#243'n de autoridades'
          Caption = 'Acta / Poder'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 4
      ...
      object dcbFechaAlta: TDateComboBox
        Left = 487
        Top = 86
        Width = 84
        Height = 21
      ...
      inline fraStaticCTBCaracter: TfraStaticCTB_TABLAS
        Left = 639
        Top = 84
        Width = 128
        Height = 23
      ...
      object GroupBox1: TGroupBox
        ...
        DesignSize = (
          197
          37)
        object rbPrestActivo: TRadioButton
          Left = 5
          Top = 16
          Width = 49
          Height = 15
        ...
        object rbPrestNoActivo: TRadioButton
          Left = 65
          Top = 16
          Width = 65
          Height = 14
        ...
        object rbPrestTodos: TRadioButton
          Left = 141
          Top = 16
          Width = 49
          Height = 15
      ...
      object gbDatosMedicos: TGroupBox
        ...
        Height = 32
        Caption = 
          'Datos M'#233'dicos - Panel no visible por pedido de ticket 48500 (lo ' +
          'dejo un tiempo por si se arrepienten)'
        Color = clSkyBlue
        ParentColor = False
        TabOrder = 10
        Visible = False
      ...
      object rgEstLegajo: TRadioGroup
        Left = 1
        Top = 124
        Width = 236
        Height = 37
  ...
  inherited ilByN: TImageList
    ...
    Top = 368
    Bitmap = {
      494C01011F002800280010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited IconosXP: TImageList
    ...
    Top = 368
    Bitmap = {
      494C010130005000280010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object ExportDialog: TExportDialog
    ...
    Fields = <
      ...
      item
        DataField = 'NOMBREFANTA'
        Title = 'Nombre de fantas'#237'a'
      end
      item
        DataField = 'TIPOPREST'
        Title = 'Tipo prestador'
      end
      item
      ...
      item
        DataField = 'ESTADOMALAPRAXIS'
        Title = 'Estado mala praxis'
      end
      item
        DataField = 'CARTILLAWEB'
        Title = 'Cartilla Web'
      end
      item
      ...
      item
        ...
        Title = 'Tipo p'#243'liza'
      end
      item
        DataField = 'COMPASEGURADORA'
        Title = 'Comp. Aseguradora'
      end
      item
        DataField = 'SM_SUMAASEGURADA'
      ...
      item
        DataField = 'estadolegajo'
        Title = 'Estado Legajo'
      end>
    IniStorage = FormPlacement
    OutputFile = 'Prestadores.txt'
    QuoteList.Strings = (
      '{NINGUNO}'
      '"'
      #39
  ...
  object SortDialog: TSortDialog
    ...
    SortFields = <
      ...
      item
        ...
        DataField = 'HABILITACIONES'
        FieldIndex = 0
      end
      item
        Title = 'Resonancia'
        DataField = 'RESONANCIA'
        FieldIndex = 0
      end
      item
        Title = 'TAC'
      ...
      item
        Title = 'Reclamos D'#233'bitos'
        DataField = 'RECLADEBITOS'
        FieldIndex = 0
      end
      item
        Title = 'Contrato'
      ...
      item
        Title = 'Contrato Mutual Vigente'
        DataField = 'CONTRATO_MUTUAL_VIG'
        FieldIndex = 0
      end
      item
        Title = 'Auditable'
  ...
  object sdqEspecialidad: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    SQL.Strings = (
  ...
  object pmImprimir: TPopupMenu
    Left = 132
    Top = 312
    object mnuImprimirDatosPrest: TMenuItem
      Caption = 'Imprimir Datos del Prestador'
      OnClick = mnuImprimirDatosPrestClick
    end
    object mnuImprimirResultados: TMenuItem
      Caption = 'Imprimir Resultados'
      OnClick = mnuImprimirResultadosClick
    end
    object mnuImprimirCartilla: TMenuItem
      Caption = 'Imprimir Cartilla Web'
      Enabled = False
      OnClick = mnuImprimirResultadosClick
    end
  end
  object QueryPrint: TQueryPrint
    ...
    Title.Text = 'Consulta de Prestadores'
  ...
  object Seguridad: TSeguridad
    ...
    Claves = <
      item
        Name = 'PermisoDesmarcarVisible'
      end
      item
        Name = 'VerDatosAuditores'
      end
      item
        Name = 'VerEstLegajos'
      end>
  ...
  object pmExportar: TPopupMenu
    Left = 245
    Top = 312
    object mnuExportarResultados: TMenuItem
      Caption = 'Exportar Resultados'
      OnClick = mnuExportarResultadosClick
    end
    object mnuExportarCartilla: TMenuItem
      Caption = 'Exportar Cartilla'
      Enabled = False
      OnClick = mnuExportarCartillaClick
    end
    object mnuExportarSecuenciasPrest: TMenuItem
      Caption = 'Exportar Secuencias del Prestador'
      OnClick = mnuExportarSecuenciasPrestClick
    end
  end
  object ExportDialogCartilla: TExportDialog
    Caption = 'Exportaci'#243'n de Datos'
    DataSet = sdqGrilla
    Fields = <
      item
  ...
  object sdqSecuencias: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    Left = 217
    Top = 368
  end
  object ExportDialogSecuencias: TExportDialog
    Caption = 'Exportaci'#243'n de Datos'
    DataSet = sdqSecuencias
    Fields = <>
    IniStorage = FormPlacement
    OutputFile = 'SecuenciasPrestador.txt'
    QuoteList.Strings = (
      '{NINGUNO}'
      '"'
      #39
