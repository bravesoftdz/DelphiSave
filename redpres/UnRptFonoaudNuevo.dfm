object rptFonoaudNuevo: TrptFonoaudNuevo
  Left = 0
  Top = 0
  Width = 816
  Height = 1344
  ...
  object sdqFonoaud: TSDQuery
    ...
    SQL.Strings = (
        ...
        '       au_idexpediente, au_fechasoli, au_aval, au_usuapro, au_fe' +
        'chapro,'
      '       NVL (au_identifapro, au_identifprestador) prestador,'
      '       NVL (au_cantapro, au_cantidad) cantidad,'
      
        '       NVL (au_detalleapro, au_detalle) detalle, ca_descripcion,' +
        ' ca_domicilio,'
      
        '       ca_localidad, ca_codarea || '#39' '#39' || ca_telefono ca_telefon' +
        'o, ca_fax, ca_identificador, ca_direlectronica, ca_codpostal,'
      
        '       au_siniestro || '#39'-'#39' || au_orden || '#39'-'#39' || au_recaida sini' +
        'estrocomp,'
      '       tj_nombre,'
      '       art.trabajador.get_telefono(tj_id, 4) Telefono,'
      '       tj_documento, tj_cuil,'
      ...
      '                                     ) domicilio,'
        ...
        '       ex_diagnostico, gp_nombre, lg_nombre, pv_descripcion, em_' +
        'nombre,'
      
        '       pr_descripcion, on_capitulo, on_codigo, on_descripcion, o' +
        'n_nomenclador, tj_fnacimiento, ex_id'
