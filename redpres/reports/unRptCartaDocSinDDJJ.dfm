inherited rptCartaDocSinDDJJ: TrptCartaDocSinDDJJ
  ...
  ReportTitle = 'Cartas Documento de ILPs sin DDJJ'
  ...
  inherited qrbSummary: TQRBand
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
          ...
          '                                         La documentaci'#243'n solici' +
          'tada deber'#225' contener la leyenda es copia fiel del original y ser' +
          ' firmada por el responsable de la Empresa.'
        ''
        
          '                                         Sin otro particular sal' +
          'udamos a Uds. muy atentamente.')
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 10
  ...
  object QRBand1: TQRBand
    ...
    object qrmTexto: TQRMemo
      ...
      Font.Style = []
      Lines.Strings = (
        'De mi mayor consideraci'#243'n:'
        
          '                                        Por medio de la presente' +
          ' nos dirigimos a Uds. con el fin de solicitarles nos remitan a l' +
          'a mayor brevedad los recibos de sueldo de/los accidentado/s que ' +
          'detallamos a continuaci'#243'n. Motiva nuestro pedido el hecho que de' +
          'bemos estimar el ingreso base mensual de acuerdo a lo normado en' +
          ' el art'#237'culo 12 de la ley 24.557.')
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 10
  ...
  object QRSubDetail1: TQRSubDetail
    ...
    object QRLabel4: TQRLabel
      ...
      AutoStretch = False
      Caption = 
        '- Fotocopias de los recibos de sueldos, incluidos SAC y vacacion' +
        'es, correspondiente a los siguientes periodos:'
      Color = clWhite
      Transparent = False
      WordWrap = True
      FontSize = 8
    ...
    object QRLabel7: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = '- Fotocopia del Documento Nacional de Identidad  1'#186' y 2'#186' p'#225'gina.'
      Color = clWhite
      Transparent = False
      WordWrap = True
      FontSize = 8
  ...
  object sdqSiniestros: TSDQuery
    ...
    SQL.Strings = (
        ...
        '          ex_fechaaccidente, tj_nombre || '#39' (DNI: '#39' || tj_docume' +
        'nto || '#39')'#39' trabajador,'
      '          sc_recibodesde, sc_recibohasta '
      
        '  from sin.ssc_siniestrosporcarta, sex_expedientes, ctj_trabajad' +
        'or'
      'where ex_id = sc_idexpediente'
      '    and tj_cuil = ex_cuil'
      '    and sc_idcarta = :pIdCarta')
    Left = 43
    Top = 65535
    ParamData = <
      item
    ...
    object sdqSiniestrosSINIESTRO: TStringField
      FieldName = 'SINIESTRO'
      Size = 4000
    end
    object sdqSiniestrosEX_FECHAACCIDENTE: TDateTimeField
      FieldName = 'EX_FECHAACCIDENTE'
    end
    object sdqSiniestrosSC_RECIBODESDE: TStringField
      FieldName = 'SC_RECIBODESDE'
    end
    object sdqSiniestrosSC_RECIBOHASTA: TStringField
      FieldName = 'SC_RECIBOHASTA'
    end
    object sdqSiniestrosTRABAJADOR: TStringField
