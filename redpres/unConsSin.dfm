inherited frmConsSin: TfrmConsSin
  Left = 456
  Top = 169
  ...
  object CoolBar1: TCoolBar [0]
    ...
    object ToolBar1: TToolBar
      ...
      object tbDetalles: TToolButton
        Left = 23
        Top = 0
        Hint = 'Detalle del Siniestro (Ctrl+D)'
        Caption = 'tbDetalles'
        ImageIndex = 15
      ...
      object tbMaxRegistros: TToolButton
        Left = 223
        Top = 0
        Hint = 'Limitar el M'#225'ximo de Registros por Consulta'
        Caption = 'tbMaxRegistros'
        ImageIndex = 19
        Style = tbsCheck
      ...
      object tbCostos: TToolButton
        Left = 285
        Top = 0
        Hint = 'Mostrar los costos del siniestro seleccionado'
        Caption = 'tbCostos'
        ImageIndex = 28
        OnClick = tbCostosClick
      end
      object tbOcultarColumnasEmp: TToolButton
        Left = 308
        Top = 0
        Hint = 'Columnas de Importes...'
        Caption = 'tbOcultarColumnasEmp'
        ImageIndex = 14
        Style = tbsCheck
        OnClick = tbOcultarColumnasEmpClick
      end
      object tbMortales: TToolButton
        Left = 331
        Top = 0
        Hint = 'Columnas de Mortales...'
        Caption = 'tbMortales'
        ImageIndex = 6
        Style = tbsCheck
        OnClick = tbMortalesClick
      end
      object tbEnfProfesional: TToolButton
        Left = 354
        Top = 0
        Hint = 'Posible enfermedad profesional'
        Caption = 'tbEnfProfesional'
        Enabled = False
        ImageIndex = 44
        Style = tbsCheck
        OnClick = tbEnfProfesionalClick
      end
      object tbPasoRegionalizacion: TToolButton
        Left = 377
        Top = 0
        Hint = 'Paso Regionalizaci'#243'n'
        Caption = 'Paso Regionalizaci'#243'n'
        Enabled = False
        ImageIndex = 21
        OnClick = tbPasoRegionalizacionClick
      end
      ...
      object tbModifDatosSin: TToolButton
        Left = 408
        Top = 0
        Hint = 'Modificar Datos del Siniestro...'
        Caption = 'tbModifDatosSin'
        ImageIndex = 24
        OnClick = tbModifDatosSinClick
      end
      object tbHistGTrabajo: TToolButton
        Left = 431
        Top = 0
        Hint = 'Hist'#243'rico de grupo de trabajo'
        Caption = 'Hist'#243'rico de grupo de trabajo'
        ImageIndex = 41
        OnClick = tbHistGTrabajoClick
      end
  ...
  object dbgListado: TArtDBGrid [1]
    Left = 0
    Top = 228
    Width = 774
    Height = 243
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'F_REASIGNACION'
        Title.Caption = 'F.Reasignaci'#243'n'
        Width = 80
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'IMPORTELIQUIDADOILP'
        Title.Caption = 'ILP'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'IMPORTELIQUIDADOILT'
        Title.Caption = 'ILT'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'IMPORTELIQUIDADOMORT'
        Title.Caption = 'Mortales'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'IMPORTECONCEPTOS'
        Title.Caption = 'Otros Conceptos'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'IMPORTEPRESTMEDICAS'
        Title.Caption = 'Prestaciones M'#233'dicas'
        Visible = False
      end
      item
        Alignment = taCenter
        Expanded = False
        FieldName = 'PORCENTLIQUIDADO'
        Title.Alignment = taCenter
        Title.Caption = 'Porc. Liq.'
        Visible = False
      end
      item
        Expanded = False
      ...
      item
        Expanded = False
        FieldName = 'DELSINIESTRO'
        Title.Caption = 'Delegaci'#243'n siniestro'
        Width = 169
        Visible = True
      end
      item
      ...
      item
        ...
        Color = clInfoBk
        Expanded = False
        FieldName = 'POSRECUPERO'
        Title.Alignment = taCenter
        Title.Caption = 'Pos.Recupero'
        Visible = False
      end
      item
        Color = clInfoBk
      ...
      item
        ...
        Color = clInfoBk
        Expanded = False
        FieldName = 'FLIQSEPELIO'
        Title.Alignment = taCenter
        Title.Caption = 'F.Liq.Sepelio'
        Visible = False
      end
      item
        Alignment = taCenter
        Color = clInfoBk
        Expanded = False
        FieldName = 'BENEFSEPELIO'
        Title.Alignment = taCenter
        Title.Caption = 'Benef.Sepelio'
        Visible = False
      end
      item
        Alignment = taCenter
      ...
      item
        Expanded = False
        FieldName = 'ex_liberatrabajo'
        Title.Caption = 'Pasa Reg.'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'ex_usuliberatrabajo'
        Title.Caption = 'Usu.Pasa Reg.'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'ex_fechaliberatrabajo'
        Title.Caption = 'Fec.Pasa Reg.'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'Por_Inca'
        Title.Caption = 'Por.Inca'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'Eve_Inca'
        Title.Caption = 'Eve.Inca'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'Fec_Inca'
        Title.Caption = 'Fec.Inca'
        Visible = False
      end
      item
        Alignment = taCenter
        ...
        FieldName = 'postalta'
        Title.Alignment = taCenter
        Title.Caption = 'Post-alta'
        Width = 55
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'EX_SINMIXSEROL'
        Title.Caption = 'Sin. Mixto Serol.'
        Width = 85
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'EX_SINMIXODONT'
        Title.Caption = 'Sin. Mixto Odont.'
        Width = 90
        Visible = True
      end
      item
      ...
      item
        ...
        FieldName = 'COMMED'
        Title.Alignment = taCenter
        Title.Caption = 'Com.Med.'
        Width = 55
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'ESTADOCRON'
        Title.Caption = 'Estado cr'#243'nico'
        Width = 78
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'PREST_INVESTIG'
        Title.Caption = 'Prestador Investig.'
        Width = 200
        Visible = True
      end
      item
        ...
        Title.Caption = 'Regi'#243'n Sanitaria Prest.'
        Width = 100
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'DOMIC_DENUNCIA'
        Title.Caption = 'Domicilio Denuncia'
        Width = 140
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'DELCONTRATO'
        Title.Caption = 'Delegaci'#243'n contrato'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'pe_psiquiatria'
        Title.Caption = 'Psiquiatr'#237'a'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'pe_fechareconsulta'
        Title.Caption = 'Reconsulta'
        Visible = True
      end
      item
        Expanded = False
  ...
  object pcFiltros: TPageControl [2]
    Left = 0
    Top = 0
    Width = 774
    Height = 199
    ...
    object sdDatosSin: TTabSheet
      ...
      object chkGTrabajo: TCheckBox
        ...
        TabOrder = 30
        OnClick = chkGTrabajoClick
      end
      object chkCIE10: TCheckBox
        Left = 484
        Top = -2
        Width = 53
        Height = 17
      ...
      object pnlFechaAcci: TPanel
        ...
        object deFechaAcciDesde: TDateComboBox
          Left = 4
          Top = 10
          Width = 84
          Height = 21
          Hint = 'Desde Fecha'
          MaxDateCombo = deFechaAcciHasta
          DialogTitle = 'La fecha desde debe ser menor a la fecha actual'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object deFechaAcciHasta: TDateComboBox
          Left = 99
          Top = 10
          Width = 84
          Height = 21
          Hint = 'Hasta Fecha'
          MinDateCombo = deFechaAcciDesde
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
      end
      object chkFechaAcci: TCheckBox
        Left = 396
        Top = 41
        Width = 115
        Height = 17
        ...
        TabOrder = 12
        OnClick = chkFechaAcciClick
      end
      object pnlFechaReca: TPanel
        Left = 0
        Top = 49
        Width = 198
        Height = 36
        ...
        object deFechaRecaDesde: TDateComboBox
          Left = 5
          Top = 10
          Width = 85
          Height = 21
          Hint = 'Desde Fecha'
          MaxDateCombo = deFechaRecaHasta
          DialogTitle = 'La fecha desde debe ser menor a la fecha actual'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object deFechaRecaHasta: TDateComboBox
          Left = 106
          Top = 10
          Width = 87
          Height = 21
          Hint = 'Hasta Fecha'
          MinDateCombo = deFechaRecaDesde
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
      end
      object chkFechaReca: TCheckBox
        Left = 5
        Top = 41
        Width = 107
        Height = 17
      ...
      object chkDelegacion: TCheckBox
        ...
        Height = 16
        TabStop = False
        Caption = 'De&legaci'#243'n del siniestro'
        TabOrder = 24
        OnClick = chkDelegacionClick
      end
      object pnlFechaReasignacion: TPanel
        Left = 577
        Top = 49
        Width = 191
        Height = 36
        ...
        object deFechaReasigDesde: TDateComboBox
          Left = 5
          Top = 10
          Width = 84
          Height = 21
          Hint = 'Desde Fecha'
          MaxDateCombo = deFechaReasigHasta
          DialogTitle = 'La fecha desde debe ser menor a la fecha actual'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object deFechaReasigHasta: TDateComboBox
          Left = 103
          Top = 10
          Width = 84
          Height = 21
          Hint = 'Hasta Fecha'
          MinDateCombo = deFechaReasigDesde
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
      end
      object chkFechaReasignacion: TCheckBox
        Left = 582
        Top = 41
        Width = 131
        Height = 17
        Caption = 'Fecha de rea&signaci'#243'n'
        TabOrder = 14
        OnClick = chkFechaReasignacionClick
      end
      object pnlTipoAccidente: TPanel
        Left = 577
        Top = 92
        Width = 188
        Height = 36
        ...
        object cmbTipoAccidente: TArtComboBox
          ...
          NumGlyphs = 1
          TabOrder = 0
          OnChange = cmbTipoAccidenteChange
          Columns = <
            item
              Expanded = False
              FieldName = 'TB_CODIGO'
          ...
          FieldKey = 'TB_CODIGO'
          OnCloseUp = cmbTipoAccidenteCloseUp
        end
        object edTipoAccidente: TEdit
          Left = 5
          Top = 10
          Width = 37
          Height = 21
          MaxLength = 1
          TabOrder = 1
          OnKeyPress = edTipoAccidenteKeyPress
        end
      end
      object chkTipoAccidente: TCheckBox
        Left = 582
        Top = 85
        Width = 110
        Height = 17
        Caption = 'Ti&po de accidente'
        TabOrder = 22
        OnClick = chkTipoAccidenteClick
      end
      object pnlGravedad: TPanel
        Left = 146
        Top = 5
        Width = 196
        Height = 36
        ...
        object edGravedad: TEdit
          ...
          MaxLength = 1
          TabOrder = 0
          OnKeyPress = edGravedadKeyPress
        end
        object cmbGravedad: TArtComboBox
          Left = 33
          Top = 10
          Width = 159
          Height = 21
          ...
          DataSource = dsGravedad
          FieldList = 'TB_DESCRIPCION'
          FieldKey = 'TB_CODIGO'
          OnCloseUp = cmbGravedadCloseUp
        end
      end
      object chkGravedad: TCheckBox
        Left = 152
        Top = -2
        Width = 69
        Height = 17
        Caption = 'Gra&vedad'
        TabOrder = 2
        OnClick = chkGravedadClick
      end
      object pnlEEPP: TPanel
        Left = 201
        Top = 92
        Width = 187
        Height = 36
        ...
        object deFechaEEPPHasta: TDateComboBox
          Left = 99
          Top = 10
          Width = 84
          Height = 21
          MinDateCombo = deFechaEEPPDesde
          TabOrder = 1
        end
        object deFechaEEPPDesde: TDateComboBox
          Left = 4
          Top = 10
          Width = 84
          Height = 21
          MaxDateCombo = deFechaEEPPHasta
          TabOrder = 0
        end
      end
      object chkEEPP: TCheckBox
        Left = 206
        Top = 85
        Width = 161
        Height = 17
        Caption = 'Fecha &marca enf. profesional'
        TabOrder = 18
        OnClick = chkEEPPClick
      end
      object pnlGestAud: TPanel
        Left = 0
        Top = 92
        Width = 198
        Height = 36
        ...
        object deGestAudHasta: TDateComboBox
          Left = 107
          Top = 10
          Width = 86
          Height = 21
          Hint = 'Hasta Fecha'
          MinDateCombo = deGestAudDesde
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object deGestAudDesde: TDateComboBox
          Left = 5
          Top = 10
          Width = 85
          Height = 21
          Hint = 'Desde Fecha'
          MaxDateCombo = deGestAudHasta
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
      end
      object chkGestAud: TCheckBox
        Left = 5
        Top = 85
        Width = 141
        Height = 15
        TabStop = False
        Caption = 'Gestionado por auditor'#237'a'
        TabOrder = 16
        OnClick = chkGestAudClick
      end
      object pnlRemis: TPanel
        Left = 389
        Top = 134
        Width = 89
        Height = 36
      ...
      object chkRemis: TCheckBox
        ...
        Caption = 'Remis'
        TabOrder = 28
        OnClick = chkRemisClick
      end
      object pnlEstadoCron: TPanel
        Left = 344
        Top = 5
        Width = 130
        Height = 36
        ...
        Enabled = False
        TabOrder = 5
        object rbActivoCron: TRadioButton
          Left = 3
          Top = 9
          Width = 54
          Height = 12
        ...
        object rbSinACron: TRadioButton
          Left = 3
          Top = 22
          Width = 90
          Height = 12
          Caption = 'S/actualizaci'#243'n'
          TabOrder = 1
        end
        object rbInactivoCron: TRadioButton
          Left = 65
          Top = 9
          Width = 62
          Height = 12
      ...
      object chkEstadoCron: TCheckBox
        Left = 351
        Top = -1
        Width = 96
        Height = 15
        TabStop = False
        Caption = 'Estado cr'#243'nicos'
        TabOrder = 4
        OnClick = chkEstadoCronClick
      end
      object pnlDelegacionContrato: TPanel
        Left = 200
        Top = 134
        Width = 188
        Height = 36
        ...
        DesignSize = (
          188
          36)
        object cmbDelegacionContrato: TArtComboBox
          Left = 43
          Top = 11
          Width = 141
          Height = 21
          ...
          NumGlyphs = 1
          TabOrder = 1
          OnChange = cmbDelegacionContratoChange
          Columns = <
            item
              Expanded = False
              FieldName = 'EL_ID'
          ...
          FieldList = 'EL_NOMBRE'
          FieldKey = 'EL_ID'
          OnCloseUp = cmbDelegacionContratoCloseUp
        end
        object edDelegacionContrato: TEdit
          Left = 4
          Top = 11
          Width = 38
          Height = 21
          TabOrder = 0
          OnKeyPress = edDelegacionContratoKeyPress
        end
      end
      object chkDelegacionContrato: TCheckBox
        Left = 205
        Top = 130
        Width = 133
        Height = 12
        TabStop = False
        Caption = 'De&legaci'#243'n del contrato'
        TabOrder = 26
        OnClick = chkDelegacionContratoClick
      end
    end
    object TabSheet2: TTabSheet
      ...
      object chkTrabajador: TCheckBox
        Left = 8
        Top = 40
        Width = 77
        Height = 17
      ...
      object pnlSectorEmpr: TPanel
        ...
        DesignSize = (
          439
          38)
        inline fraSectorEmpr: TfraStaticCTB_TABLAS
          Left = 6
          Top = 10
          Width = 430
          Height = 23
      ...
      object chkSectorEmpr: TCheckBox
        Left = 8
        Top = 83
        Width = 97
        Height = 17
        ...
        TabOrder = 5
        OnClick = chkSectorEmprClick
      end
      object chkRegSanitPrestador: TCheckPanel
        Left = 442
        Top = 84
        Width = 322
        Height = 43
        Anchors = [akTop, akRight]
        Caption = ' Regi'#243'n Sanitaria Prestador '
        TabOrder = 7
        OnClick = chkRegSanitPrestadorClick
        Checked = False
        DesignSize = (
          322
          43)
      ...
      object Panel1: TPanel
        ...
        object chkSinMixOdontologico: TCheckBox
          Left = 127
          Top = 18
          Width = 50
          Height = 17
          Hint = 'Siniestro mixto odontol'#243'gico'
          Caption = 'Odont.'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 5
        end
        object chkSinMixSerologico: TCheckBox
          Left = 127
          Top = 3
          Width = 50
          Height = 17
          Hint = 'Siniestro mixto serol'#243'gico'
          Caption = 'Serol.'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 4
        ...
        object chkComMed: TCheckBox
          ...
          Width = 69
          Height = 17
          Hint = 'Dictamen de comisi'#243'n medica'
          Caption = 'Com.Med.'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 6
        end
        object chkInvestAdmin: TCheckBox
          Left = 184
          Top = 18
          Width = 56
          Height = 17
          Hint = 'Investigaci'#243'n Administrativa'
          Caption = 'Invest.'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 7
        end
        object chkIntercurrencia: TCheckBox
          Left = 255
          Top = 3
          Width = 65
          Height = 17
        ...
        object chkPsiquiatria: TCheckBox
          Left = 255
          Top = 18
          Width = 65
          Height = 17
  ...
  object ScrollBox1: TScrollBox [3]
    ...
    TabOrder = 3
    Visible = False
    object qrResumenSiniestros: TQuickRep
      Left = 8
      Top = 8
      Width = 1344
      Height = 816
      ...
      PrintIfEmpty = True
      ReportTitle = 'Resumen de Siniestros por Asegurado'
      SnapToGrid = True
      Units = MM
      Zoom = 100
      ...
      object PageHeaderBand1: TQRBand
        ...
        object qrlTitulo: TQRLabel
          ...
          AlignToBand = False
          AutoSize = False
          Caption = 'RESUMEN DE SINIESTROS POR ASEGURADO'
          Color = clScrollBar
        ...
        object QRLabel26: TQRLabel
          ...
          Alignment = taLeftJustify
          AlignToBand = False
          Caption = 'Siniestros de la Empresa:'
          Color = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -15
  ...
  object fpDatosSiniestro: TFormPanel [4]
    Left = 316
    Top = 300
    Width = 237
    Height = 185
    Caption = 'Modificar datos del Siniestro'
    FormWidth = 0
    FormHeigth = 0
    FormLeft = 0
    FormTop = 0
    ...
    object gbDatosSinMixtos: TGroupBox
      Left = 7
      Top = 30
      Width = 221
      Height = 62
      Caption = ' Datos de Siniestros Mixtos '
      TabOrder = 0
      object chkOdontologico: TCheckBox
        Left = 16
        Top = 38
        Width = 162
        Height = 17
        Caption = 'Siniestro Mixto Odontol'#243'gico'
        TabOrder = 1
      end
      object chkSerologico: TCheckBox
        Left = 16
        Top = 17
        Width = 164
        Height = 17
        Caption = 'Siniestro Mixto Serol'#243'gico'
        TabOrder = 0
      end
    end
    object gbGestAud: TGroupBox
      Left = 7
      Top = 95
      Width = 222
      Height = 42
      Caption = ' Gestionado por Auditor'#237'a '
      TabOrder = 1
      object dcGestAud: TDateComboBox
        Left = 51
        Top = 16
        Width = 110
        Height = 21
        Hint = 'Fecha de Gestionado por Auditor'#237'a'
        Color = clWhite
        Ctl3D = True
        ParentCtl3D = False
        ParentShowHint = False
  ...
  object fpHistGT: TFormPanel [5]
    ...
    object gridHGTrabajo: TArtDBGrid
      Left = 12
      Top = 16
      Width = 569
      Height = 209
      Anchors = [akLeft, akTop, akRight, akBottom]
      DataSource = dsHGtrabajo
  ...
  object SortDialog: TSortDialog
    ...
    SortFields = <
      ...
      item
        Title = 'F.Reasignaci'#243'n'
        DataField = 'F_REASIGNACION'
        FieldIndex = 0
      end
      item
        Title = 'CIE10'
      ...
      item
        Title = 'Mortales'
        DataField = 'IMPORTELIQUIDADOMORT'
        FieldIndex = 0
      end
      item
        Title = 'Otros Conceptos'
        DataField = 'IMPORTECONCEPTOS'
        FieldIndex = 0
      end
      item
        Title = 'Prestaciones M'#233'dicas'
        DataField = 'IMPORTEPRESTMEDICAS'
        FieldIndex = 0
      end
      item
      ...
      item
        Title = 'Delegaci'#243'n siniestro'
        DataField = 'delsiniestro'
        FieldIndex = 0
      end
      item
      ...
      item
        Title = 'Breve descripci'#243'n'
        DataField = 'EX_BREVEDESCRIPCION'
        FieldIndex = 0
      end
      item
        Title = 'Regi'#243'n Sanitaria'
        DataField = 'REGIONSANITARIA'
        FieldIndex = 0
      end
      item
        Title = 'Sector Empresa'
        DataField = 'DESCRSECTOR'
        FieldIndex = 0
      end
      item
        Title = 'Sin.Mix.Serol.'
        DataField = 'ex_sinmixserol'
        FieldIndex = 0
      end
      item
        Title = 'Sin.Mix.Odont.'
        DataField = 'ex_sinmixodont'
        FieldIndex = 0
      end
      item
  ...
  object QueryPrint: TQueryPrint
    ...
    Fields = <
      ...
      item
        Title = 'Delegaci'#243'n contrato'
        DataField = 'delcontrato'
        MaxLength = 0
      end
      item
        Title = 'Psiquiatr'#237'a'
        DataField = 'pe_psiquiatria'
        MaxLength = 0
      end
      item
        Title = 'Reconsulta'
    ...
    Title.Text = 'Consulta de Siniestros'
    Title.Logo.Alignment = taLeftJustify
    Title.Logo.Height = 19
    ...
    Headers.Color = clInactiveCaption
    ...
    Footer.Font.Style = []
    Totals.Color = clInactiveCaption
    Totals.Font.Charset = DEFAULT_CHARSET
    Totals.Font.Color = clWhite
    Totals.Font.Height = -8
    Totals.Font.Name = 'Tahoma'
    Totals.Font.Style = []
    SubTotals.Color = clInactiveCaption
  ...
  object Seguridad: TSeguridad
    ...
    Claves = <
      item
        Name = 'VerInfoMortales'
      end
      item
        Name = 'DesmarcarPosEP'
      end
      item
        Name = 'VerColumnaJuicio'
      end>
  ...
  object ShortCutControl: TShortCutControl
    ShortCuts = <
      ...
      item
        Key = 16461
        OnShortCutPress = tbMaxRegistrosClick
        LinkControl = tbMaxRegistros
      end
      item
        Key = 16467
  ...
  object sdqDatos: TSDQuery
    ...
    SQL.Strings = (
      ...
      '       EX_CUIL, TJ_NOMBRE,  EX_CUIT, EM_NOMBRE,'
        ...
        '       ex_fechaaccidente, ex_fecharecaida,  ex_bajamedica, ex_al' +
        'tamedica, EX_FECHAREASIGNACION F_REASIGNACION,'
      
        '       LG_NOMBRE, ex_diagnosticooms, ex_fechaalta, ca_descripcio' +
        'n PRESTADORSIN, CA_FECHABAJA, ca_localidad,'
      '       pv_descripcion PROVPREST, gp_nombre,'
      
        '       ART.SINIESTRO.Get_MotivoRechazo(EX_SINIESTRO, EX_ORDEN, E' +
        'X_RECAIDA) MotivoRechazo,'
      
        '       LIQ.Get_ImporteLiquidadoILT(EX_SINIESTRO, EX_ORDEN, EX_RE' +
        'CAIDA) ImporteLiquidadoILT,'
      
        '       LIQ.Get_ImporteLiquidadoILP(EX_SINIESTRO, EX_ORDEN, EX_RE' +
        'CAIDA) ImporteLiquidadoILP,'
      
        '       LIQ.Get_ImporteLiquidadoMortales(EX_SINIESTRO, EX_ORDEN, ' +
        'EX_RECAIDA) ImporteLiquidadoMort,'
      
        '       LIQ.Get_ImporteConceptos(EX_SINIESTRO, EX_ORDEN, EX_RECAI' +
        'DA) ImporteConceptos,'
      
        '       ART.SIN.GET_CANTDIASCAIDOS(EX_SINIESTRO, EX_ORDEN, EX_REC' +
        'AIDA) DIASCAIDOS, '
      
        '       AMEBPBA.Get_ImportePrestMedicas(EX_SINIESTRO, EX_ORDEN, E' +
        'X_RECAIDA) ImportePrestMedicas,'
      
        '       SIEST.TB_DESCRIPCION Estado, CATER.TB_DESCRIPCION Causafi' +
        'n, TACC.tb_descripcion TipoAccidente,'
      '       GRAV.tb_descripcion Gravedad,'
      
        '       art.varios.get_regionsanitaria(tj_cpostal, tj_localidad) ' +
        'RegionSanitaria,'
      '     NVL (ex_posiblerecupero, '#39'N'#39') posrecupero,'
      
        '     art.liq.get_importeporconcepto (ex_siniestro,ex_orden,ex_re' +
        'caida,'#39'53'#39') anticipo,'
      
        '     art.liq.get_importeporconcepto (ex_siniestro,ex_orden,ex_re' +
        'caida,'#39'8'#39') definitivo,'
      
        '     art.liq.get_importeporconcepto (ex_siniestro,ex_orden,ex_re' +
        'caida,'#39'55'#39') pagounico,'
      
        '     art.liq.get_destinatporconcepto (ex_siniestro,ex_orden,ex_r' +
        'ecaida,'#39'8'#39') benefdefi,'
      
        '     art.liq.get_importeporotrosconceptos (ex_siniestro,ex_orden' +
        ',ex_recaida,'#39'5'#39') sepelio,'
      
        '     art.liq.get_maxfechaporotrosconceptos (ex_siniestro,ex_orde' +
        'n,ex_recaida,'#39'5'#39') fliqsepelio,'
      
        '     art.liq.get_destinatporotrosconceptos (ex_siniestro,ex_orde' +
        'n,ex_recaida,'#39'5'#39') benefsepelio,'
      
        '     art.amebpba.get_denunciasrt (ex_siniestro,ex_orden,ex_recai' +
        'da) denunciasrt,'
      '     nvl(ex_fecharecaida, ex_fechaaccidente) fechaaccidente,'
      
        '     art.liq.get_importeliquidadoilt (ex_siniestro,ex_orden,ex_r' +
        'ecaida) + '
      
        '     art.liq.get_importeconceptos (ex_siniestro,ex_orden,ex_reca' +
        'ida ) pagos,'
      
        '     lf_descripcion Forma, la_descripcion Agente, ln_descripcion' +
        ' Naturaleza, lz_descripcion Zona,'
      '    dg_descripcion, ex_fecharecepcion, ex_diagnostico,'
      
        '    utiles.armar_domicilio(ca_calle, ca_numero, ca_piso, ca_depa' +
        'rtamento, ca_localidad) domprest,'
      '    ca_telefono,'
      
        '    art.liq.get_maxporcliquidado(ex_siniestro, ex_orden, ex_reca' +
        'ida) PorcentLiquidado,'
      
        '    amebpba.get_cantreqsrt(ex_siniestro, ex_orden, ex_recaida) R' +
        'eqSRT,'
      '    ex_posibleeepp, ex_usuposibleeepp, ex_fechaposibleeepp,'
      
        '    cont.is_empresafondo(ex_cuit) isempfondo, nvl(ex_tipo,'#39'1'#39') t' +
        'iposin, siniestro.get_usuariogestor(ex_id) USUGESTOR,'
      '    ex_SinMixSerol, ex_SinMixOdont,'
      
        '    UD_NOMBRE Establecimiento, art.utiles.armar_domicilio(ud_cal' +
        'le,ud_numero,ud_piso,ud_departamento,ud_localidad) Domic_Denunci' +
        'a,'
      
        '    art.protocolo.get_proximocontrol(ex_siniestro, ex_orden, ex_' +
        'recaida) as fecha_prox_control'
      ''
      
        '  FROM CTB_TABLAS CATER, CTB_TABLAS SIEST, CTB_TABLAS TACC, CTB_' +
        'TABLAS GRAV, '
      
        '       DLG_DELEGACIONES, MGP_GTRABAJO, CPV_PROVINCIAS, CPR_PREST' +
        'ADOR,'
      '       AEM_EMPRESA, CTJ_TRABAJADORES, SEX_EXPEDIENTES,'
      
        '       cdg_diagnostico, SIN.slf_lesionforma,SIN.sla_lesionagente' +
        ','
      '       SIN.sln_lesionnaturaleza, SIN.slz_lesionzona,'
      '       SIN.SUD_UBICACIONDENUNCIA, SIN.SDE_DENUNCIA'
      ''
      ...
      ''
      '   AND CATER.TB_CLAVE(+) = '#39'CATER'#39
      '   AND CATER.TB_CODIGO(+) = ex_causafin'
      ''
      '   AND SIEST.TB_CLAVE = '#39'SIEST'#39
      '   AND SIEST.TB_CODIGO = EX_ESTADO'
      ''
      '   AND TACC.TB_CLAVE(+) = '#39'STIPO'#39
      
        '   AND TACC.TB_CODIGO(+) = ART.UTILES.IIF_CHAR(ex_Tipo,'#39' '#39','#39'1'#39', ' +
        'ex_tipo)'
      ''
      '   AND GRAV.TB_CLAVE(+) = '#39'GRAV'#39
      
        '   AND GRAV.TB_CODIGO(+) = ART.UTILES.IIF_CHAR(ex_gravedad, '#39' '#39',' +
        ' '#39'1'#39',ex_gravedad)'
      ''
  ...
  object ExportDialog: TExportDialog
    ...
    Fields = <
      ...
      item
        DataField = 'ESTADOCRON'
        Title = 'Estado cr'#243'nicos'
      end
      item
        DataField = 'JUICIO'
        Title = 'Juicio'
      ...
      item
        DataField = 'DOMIC_DENUNCIA'
        Title = 'Domicilio Denuncia'
      end
      item
        DataField = 'FECHA_PROX_CONTROL'
        Title = 'Pr'#243'x. Control'
      end
      item
        DataField = 'delcontrato'
        Title = 'Delegaci'#243'n contrato'
  ...
  object sdqDelegacion: TSDQuery
    ...
    Options = []
    SQL.Strings = (
      'SELECT   el_id, el_nombre, el_localidad,'
      
        '         utiles.armar_domicilio (el_calle,  el_numero, el_piso, ' +
        'el_departamento) direccion,'
      
        '         utiles.armar_telefono (el_codareatelefonos, NULL,  el_t' +
        'elefonos) telefono'
      '    FROM del_delegacion'
      '   WHERE el_sistema = '#39'S'#39
      'ORDER BY el_nombre')
    Left = 19
    Top = 145
  end
  ...
  object sdqGravedad: TSDQuery
    DatabaseName = 'dbPrincipal'
    Options = []
    SQL.Strings = (
      'select tb_codigo, tb_descripcion from ctb_tablas'
      'where tb_clave = '#39'SGRAV'#39
      '  and tb_codigo <> 0')
    Left = 231
    Top = 21
  end
  object dsGravedad: TDataSource
    DataSet = sdqGravedad
    Left = 259
    Top = 21
  end
  object pmImprimir: TPopupMenu
    Left = 128
    Top = 292
    object mnuListado: TMenuItem
      Caption = 'Listado'
      OnClick = mnuListadoClick
    end
    object mnuResumenSiniestros: TMenuItem
      Caption = 'Resumen de Siniestros por Asegurado'
      OnClick = mnuResumenSiniestrosClick
    end
  end
  object sdqhgtrabajo: TSDQuery
    DatabaseName = 'dbprincipal'
    Options = []
    SQL.Strings = (
      'SELECT hg_siniestro, hg_orden, hg_recaida, hg_gtrabajo, '
      '               hg_usualta, hg_fechalta, hg_gestor, gp_nombre,'
      
        '               art.utiles.armar_siniestro(hg_siniestro, hg_orden' +
        ', hg_recaida) siniestro'
      '  FROM art.shg_historiagrupotrabajo, art.mgp_gtrabajo'
      ' WHERE hg_gtrabajo = gp_codigo'
      '   AND gp_fbaja IS NULL'
      '   AND hg_siniestro = :sin'
      '   AND hg_orden = :ord'
      '   AND hg_recaida = :rec')
    Left = 464
    Top = 356
  ...
  object dsHGtrabajo: TDataSource
    DataSet = sdqhgtrabajo
    Left = 492
    Top = 356
  end
end
