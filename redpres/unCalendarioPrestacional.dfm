object frmCalendarioPrestacional: TfrmCalendarioPrestacional
  Left = 268
  Top = 148
  Width = 800
  Height = 550
  ...
  object Panel1: TPanel
    ...
    object pDia: TDBPlanner
      ...
      DefaultItem.SelectColor = clMenuBar
      DefaultItem.SelectFontColor = clMaroon
      DefaultItem.Shadow = True
      DefaultItem.TrackColor = clMaroon
      DefaultItem.TrackSelectColor = clMaroon
      DeleteGlyph.Data = {
      ...
      Display.ActiveEnd = 26
      Display.DisplayStart = 14
      Display.DisplayEnd = 61
      Display.DisplayScale = 25
      Display.ColorActive = clInfoBk
      Display.ColorNonActive = clMenuBar
  ...
  object sdqCalendario: TSDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT   tipo, id, idexpediente, fecha, hora, detalle, observaci' +
        'ones, formulario'
