...
var ssql: string;
begin
  Verificar(sdqConsulta.FieldByName('el_pendienteliq').AsString <> 'S', ToolBar, 'El estado del caso no permite esta acción');
  Verificar(sdqConsulta.FieldByName('faccidente').AsDateTime + 365*2 > DBDate, ToolBar, 'La fecha de accidente debe tener una antiguedad de al menos dos años para realizar esta acción');
...
begin
  Verificar(sdqConsulta.FieldByName('el_pendienteliq').AsString <> 'S', ToolBar, 'El estado del caso no permite solicitar documentación');
