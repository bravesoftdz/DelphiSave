...
begin
  ...
  CambiarEstilo(fraTrabajadorSIN.edSiniestro.FOrden, TieneMultiplesOrdenes(Siniestro, Orden), 'Existen siniestros múltiples');
  { Pone en negrita la Recaída si existen recaídas del siniestro }
  CambiarEstilo(fraTrabajadorSIN.edSiniestro.FRecaida, TieneMultiplesRecaidas(Siniestro, Orden, Recaida), 'Existen recaídas múltiples');
...
begin
  DoLimpiarDatos;
  with fraTrabajadorSIN.edSiniestro do
  begin
    FOrden.Font.Style   := [];
    FRecaida.Font.Style := [];
